...
std::shared_ptr< propagators::SingleArcSimulationResults<> > createAndRunSimulation( const simulation_setup::SystemOfBodies&,
                                                                                     const basic_astrodynamics::AccelerationMap&,
...
std::ostream& operator<<( std::ostream& os, const Settings& settings )
{
    ...
    std::copy( settings.numberOfPanelsPerRingMoon.begin( ),
               settings.numberOfPanelsPerRingMoon.end( ),
