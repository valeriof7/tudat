...
int main( )
{
    ...
    std::cout << "Actual shadow function: "
              << occultationModel.evaluateReceivedFractionFromExtendedSource( sourcePosition, sourceShape, targetPosition ) << std::endl;

    std::cout << "Estimated shadow function: " << estimateShadowFunction( occultationModel ) << std::endl;
