...
void cannonballTargetOld( int i )
{
    ...
    bodySettings.addSettings( "LRO" );
    bodySettings.at( "LRO" )->constantMass = lroMass;
    bodySettings.at( "LRO" )->radiationPressureSettings[ "Sun" ] = cannonBallRadiationPressureSettings( "Sun", lroArea, lroCp, { "Moon" } );
    ...
    SelectedAccelerationMap accelerationMap{ { "LRO",
                                               {
                                                       ...
                                                       { "Sun", { cannonBallRadiationPressureAcceleration( ) } },
                                               } } };
        ...
        { "LRO",
          {
                  ...
                  { "Sun", { std::make_shared< AccelerationSettings >( panelled_radiation_pressure_acceleration ) } },
          } }
    };
...
{
    auto integratorSettings = rungeKuttaFixedStepSettings( stepSize, rungeKuttaFehlberg78 );
