 ...
 * the link is to be checkd. The second entry denotes the index for the opposite end of the link. \param linkEnds Complete set of link ends
 * for which check is to be performed \param observableType Observable type for which check is to be performed \param linkEndToCheck Link
 * end at which check is to be performed \return Link end indices in link end states/times that are to be used in viability calculation
 */
