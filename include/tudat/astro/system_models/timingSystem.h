 ...
 * 1065. \param allanVarianceAmplitudes Allan variance amplitudes, with key as power of time and value the mulitplying factor (amplitude).
 ...
 * of flicker phase noise, the logarithmic term will be neglected when using this function. \param Map with phase noise amplitudes, powers
 * of frequency as keys and ampliutdes as values.
 */
 ...
 * domain. \param allanVarianceAmplitudes Allan variance amplitudes, with key as power of time and value the mulitplying factor (amplitude).
 ...
 * using this function. \return Pair containing first: vector of clock noise realizations, second: time step between subsequent realizations
 * of clock noise.
 */
 ...
 *  \param isInverseSquareTermFlickerPhaseNoise Boolean determining whether inverse square time term is flicker phase noise (freq.^(-1)) or
 *  white phase modulation (freq.^(0)). Note that for allan variance of flicker phase noise, the logarithmic term will be neglected when
 * using this function. \return Map of clock noise realizations, with associated times as keys and noise as values.
 */
 ...
 * differences smaller than the time between two subsequent noise realizations. \param allanVarianceAmplitudes Allan variance amplitudes,
 * with key as power of time and value the mulitplying factor (amplitude). \param startTime Start time of noise time series generation
 *  \param endTime End time of noise time series generation
 *  \param timeStep Sampling time setp in discrete relaizations of continuous random process to generate
 *  \param isInverseSquareTermFlickerPhaseNoise Boolean determining whether inverse square time term is flicker phase noise (freq.^(-1)) or
 *  white phase modulation (freq.^(0)). Note that for allan variance of flicker phase noise, the logarithmic term will be neglected when
 * using this function. \return Function that returns clock noise as a function of time.
 */
 ...
 * transformed to time domain to yoield a time series of random errors, which are a realization of the requested allan variance behaviour.
 * Subsequently, an interpolator is created using the discrete noise realizations. Note that the power spectrum is no longer valid at time
 * differences smaller than the time between two subsequent noise realizations. \param allanVarianceNodes Allan variance nodes, with key as
 * integration time and value as ADEV/HDEV \param varianceType Allan or Hadamard \param startTime Start time of noise time series generation
 *  \param endTime End time of noise time series generation
 *  \param timeStep Sampling time setp in discrete relaizations of continuous random process to generate
