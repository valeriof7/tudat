...
public:
    ...
    double getComponentFunctionCurrentValue( const int componentIndex, const double independentVariable );

    double getComponentFunctionDerivativeCurrentValue( const int componentIndex, const double independentVariable );

    double getComponentFunctionIntegralCurrentValue( const int componentIndex, const double independentVariable );
