 ...
 * currentUnifiedStateModelElements Current USM6 elements of the body for which the equations of motion are to be evaluated \param
 ...
 * Gravitational parameter of sum of central body and body for which orbit is propagated. \return Time derivatives of USM6 elements.
 */
Eigen::Vector7d computeStateDerivativeForUnifiedStateModelModifiedRodriguesParameters(
        const Eigen::Vector7d& currentUnifiedStateModelElements,
