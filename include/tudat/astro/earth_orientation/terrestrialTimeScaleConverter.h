                      ...
                      const Eigen::Vector3d& earthFixedPosition )
    {
        ...
        switch( inputScale )
        {
            case basic_astrodynamics::tdb_scale:
                ...
                tdbMinusTt = static_cast< TimeType >(
                        this->getTDBminusTT( inputTimeValue, siteLongitude, distanceFromSpinAxis, distanceFromEquatorialPlane ) );
            ...
            case basic_astrodynamics::tai_scale:
                ...
                tdbMinusTt = static_cast< TimeType >(
                        this->getTDBminusTT( timesToUpdate.tt, siteLongitude, distanceFromSpinAxis, distanceFromEquatorialPlane ) );
                timesToUpdate.tdb = timesToUpdate.tt + tdbMinusTt;
            ...
            case basic_astrodynamics::ut1_scale:
                ...
                timesToUpdate.tai = sofa_interface::convertUTCtoTAI< TimeType >( timesToUpdate.utc );
                timesToUpdate.tt = basic_astrodynamics::convertTAItoTT< TimeType >( timesToUpdate.tai );
                tdbMinusTt = this->getTDBminusTT( timesToUpdate.tt, siteLongitude, distanceFromSpinAxis, distanceFromEquatorialPlane );
                timesToUpdate.tdb = timesToUpdate.tt + tdbMinusTt;
...
private:
                          ...
                          const double distanceFromEquatorialPlane )
    {
        ...
        {
            return sofa_interface::getTDBminusTT( ttOrTdbSinceJ2000, stationLongitude, distanceFromSpinAxis, distanceFromEquatorialPlane );
        }
    }
