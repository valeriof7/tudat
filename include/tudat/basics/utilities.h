 ...
 * value of isOffsetAppliedFirst input variable) \param isOffsetAppliedFirst Boolean denoting order in which offset and scale are to be
 * applied to existing map keys.
 */
 ...
 * forward iterator. The map keys are not used for the return vector. \param inputMap Original map from which the vector is to be created
 ...
 * iterator. The map values are not used for the return vector. \param inputMap Original map from which the vector is to be created \return
 * Vector created from the map keys
 */
template< typename VectorArgument, typename KeyType >
 ...
 * permissible, i.e. an S pointer must succesfully dynamic cast to a T pointer (T shoudl typically derive from S). \param originalVector
 * Vector of S shared pointers. \return Dynamic casted vector of T shared pointers.
 */
template< typename S, typename T >
 ...
 * by a forward iterator. The multimap keys are not used for the return vector. \param inputMap Original multimap from which the vector is
 * to be created \return Vector created from the multimap values
 */
template< typename VectorArgument, typename KeyType >
 ...
 * a forward iterator. The multimap values are not used for the return vector. \param inputMap Original multimap from which the vector is to
 * be created \return Vector created from the multimap keys
 */
template< typename VectorArgument, typename KeyType >
