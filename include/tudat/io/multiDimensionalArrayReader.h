...
public:
     ...
     */
    static boost::multi_array< double, static_cast< size_t >( NumberOfDimensions ) > readMultiArray( const std::string fileName );
     ...
     */
    static std::pair< boost::multi_array< double, 1 >, std::vector< std::vector< double > > > readMultiArrayAndIndependentVariables(
...
public:
     ...
     *  \return Multi-array containing file contents.
     */
    static boost::multi_array< double, 1 > readMultiArray( const std::string fileName )
    {
            ...
            const std::string fileName )
    {
        ...
        if( !( independentVariables.size( ) == 1 ) )
        {
            throw std::runtime_error(
                    "Error when reading 3-D multi-array, wrong number of independent variables found"
        ...
        return std::make_pair( parseRawOneDimensionalCoefficientsFromFile( independentVariableSize, coefficientBlock ),
...
public:
     ...
     *  \return Multi-array containing file contents.
     */
    static boost::multi_array< double, 2 > readMultiArray( const std::string fileName )
    {
        return readMultiArrayAndIndependentVariables( fileName ).first;
    }
     ...
     *  variables at which coefficients are defined.
     */
    static std::pair< boost::multi_array< double, 2 >, std::vector< std::vector< double > > > readMultiArrayAndIndependentVariables(
            const std::string fileName )
    {
        std::vector< std::vector< double > > independentVariables;
        Eigen::MatrixXd coefficientBlock;
        ...
        // Parse data from file
        return std::make_pair( parseRawTwoDimensionalCoefficientsFromFile( independentVariableSize, coefficientBlock ),
                               independentVariables );
    }
};
...
public:
     ...
     *  \return Multi-array containing file contents.
     */
    static boost::multi_array< double, 3 > readMultiArray( const std::string fileName )
    {
        return readMultiArrayAndIndependentVariables( fileName ).first;
    }
     ...
     *  variables at which coefficients are defined.
     */
    static std::pair< boost::multi_array< double, 3 >, std::vector< std::vector< double > > > readMultiArrayAndIndependentVariables(
            const std::string fileName )
    {
        std::vector< std::vector< double > > independentVariables;
        Eigen::MatrixXd coefficientBlock;
        ...
        // Parse data from file
        return std::make_pair( parseRawThreeDimensionalCoefficientsFromFile( independentVariableSize, coefficientBlock ),
                               independentVariables );
    }
};
...
public:
     ...
     *  \return Multi-array containing file contents.
     */
    static boost::multi_array< double, 4 > readMultiArray( const std::string fileName )
    {
        return readMultiArrayAndIndependentVariables( fileName ).first;
    }
     ...
     *  variables at which coefficients are defined.
     */
    static std::pair< boost::multi_array< double, 4 >, std::vector< std::vector< double > > > readMultiArrayAndIndependentVariables(
            const std::string fileName )
    {
        std::vector< std::vector< double > > independentVariables;
        Eigen::MatrixXd coefficientBlock;
        ...
        {
            throw std::runtime_error(
                    "Error when reading 4-D multi-array, wrong number of independent variables found"
        ...
        // Parse data from file
        return std::make_pair( parseRawFourDimensionalCoefficientsFromFile( independentVariableSize, coefficientBlock ),
                               independentVariables );
    }
};
