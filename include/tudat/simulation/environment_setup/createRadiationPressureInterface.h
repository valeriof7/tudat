...
public:
     ...
     */
    RadiationPressureInterfaceSettings( const RadiationPressureType radiationPressureType,
     ...
     */
    RadiationPressureType getRadiationPressureType( )
    {
        return radiationPressureType_;
    }
...
public:
    ...
    std::function< double( const double ) > getRadiationPressureCoefficientFunction( )
    {
        return radiationPressureCoefficientFunction_;
    }
