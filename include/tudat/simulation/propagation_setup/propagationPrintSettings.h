...
{
public:
    PropagationPrintSettings( const bool printNumberOfFunctionEvaluations = false,
    ...
    bool getPrintProcessedStateData( )
    {
        return printProcessedStateData_;
    }
    ...
    double getResultsPrintFrequencyInSeconds( )
    {
        return resultsPrintFrequencyInSeconds_;
    }
    ...
    double getResultsPrintFrequencyInSteps( )
    {
        return resultsPrintFrequencyInSteps_;
    }
    ...
    bool getPrintInitialAndFinalConditions( )
    {
        return printInitialAndFinalConditions_;
    }
    ...
    bool getPrintDependentVariableDuringPropagation( )
    {
        return printDependentVariableDuringPropagation_;
    }
    ...
    bool printCurrentStep( const int stepsSinceLastPrint, const double timeSinceLastPrint )
    {
