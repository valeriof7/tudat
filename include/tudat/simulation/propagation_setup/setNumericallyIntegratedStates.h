...
public:
    ...
    RotationalStateIntegratedStateProcessor( const int startIndex,
                                             const simulation_setup::SystemOfBodies& bodies,
                                             const std::vector< std::string >& bodiesToIntegrate ):
        SingleArcIntegratedStateProcessor< TimeType, StateScalarType >( rotational_state,
                                                                        std::make_pair( startIndex, 7 * bodiesToIntegrate.size( ) ),
                                                                        bodies,
                                                                        bodiesToIntegrate )
    { }
...
public:
    ...
    BodyMassIntegratedStateProcessor( const int startIndex,
                                      const simulation_setup::SystemOfBodies& bodies,
                                      const std::vector< std::string >& bodiesToIntegrate ):
        SingleArcIntegratedStateProcessor< TimeType, StateScalarType >( body_mass_state,
