 ...
 * retrieved from the system of bodies. \param cartesianPositionAtDeparture Cartesian position of the body to the propagated at the leg
 * departure [m]. If not provided as input, it is retrieved from the ephemerides.
 */
