...
int main( )
{
    ...
    variableVector << -789.8117, 158.302027105278, 449.385873819743, 54.7489684339665, 1024.36205846918, 4552.30796805542, 1 /*dummy*/;
    ...
    Trajectory Cassini1( numberOfLegs,
                         legTypeVector,
                         ephemerisVector,
    ...
    std::cout << " Time of Earth departure: " << timeVector[ 0 ] << ". Delta V needed at Earth: " << deltaVVector[ 0 ] << std::endl;
    std::cout << " Time of Venus visit: " << timeVector[ 1 ] << ". Delta V needed at Venus: " << deltaVVector[ 1 ] << std::endl;
    std::cout << " Time of second Venus visit: " << timeVector[ 2 ] << ". Delta V needed at Venus: " << deltaVVector[ 2 ] << std::endl;
    std::cout << " Time of Earth visit: " << timeVector[ 3 ] << ". Delta V needed at Earth: " << deltaVVector[ 3 ] << std::endl;
    std::cout << " Time of Jupiter visit: " << timeVector[ 4 ] << ". Delta V needed at Jupiter: " << deltaVVector[ 4 ] << std::endl;
    std::cout << " Time of Saturn capture: " << timeVector[ 5 ] << ". Delta V needed at Saturn: " << deltaVVector[ 5 ] << std::endl;
    ...
    variableVector << 1171.64503236 * physical_constants::JULIAN_DAY, 399.999999715 * physical_constants::JULIAN_DAY,
            178.372255301 * physical_constants::JULIAN_DAY, 299.223139512 * physical_constants::JULIAN_DAY,
    ...
    // Create the trajectory problem.
    Trajectory Messenger( numberOfLegs,
                          legTypeVector,
                          ephemerisVector,
                          gravitationalParameterVector,
                          variableVector,
    ...
    std::cout << " Time of Earth departure: " << timeVectorMessenger[ 0 ] << ". Delta V needed at Earth: " << deltaVVectorMessenger[ 0 ]
              << std::endl;
    std::cout << " Time of 1st DSM: " << timeVectorMessenger[ 1 ] << ". Delta V needed for 1st DSM: " << deltaVVectorMessenger[ 1 ]
              << std::endl;
    std::cout << " Time of second Earth visit: " << timeVectorMessenger[ 2 ] << ". Delta V needed at Earth: " << deltaVVectorMessenger[ 2 ]
              << std::endl;
    std::cout << " Time of 2nd DSM: " << timeVectorMessenger[ 3 ] << ". Delta V needed for 2nd DSM: " << deltaVVectorMessenger[ 3 ]
              << std::endl;
    std::cout << " Time of Venus visit: " << timeVectorMessenger[ 4 ] << ". Delta V needed at Venus: " << deltaVVectorMessenger[ 4 ]
              << std::endl;
    std::cout << " Time of 3d DSM: " << timeVectorMessenger[ 5 ] << ". Delta V needed for 3d DSM: " << deltaVVectorMessenger[ 5 ]
              << std::endl;
    std::cout << " Time of second Venus visit: " << timeVectorMessenger[ 6 ] << ". Delta V needed at Venus: " << deltaVVectorMessenger[ 6 ]
              << std::endl;
    std::cout << " Time of 4th DSM: " << timeVectorMessenger[ 7 ] << ". Delta V needed for 4th DSM: " << deltaVVectorMessenger[ 7 ]
              << std::endl;
    std::cout << " Time of Mercury capture: " << timeVectorMessenger[ 8 ] << ". Delta V needed at Mercury: " << deltaVVectorMessenger[ 8 ]
              << std::endl;
    ...
    // Venus
    returnSingleRevolutionPlanetTrajectory( std::make_shared< ephemerides::ApproximatePlanetPositions >(
                                                    ephemerides::ApproximatePlanetPositionsBase::BodiesWithEphemerisData::venus ),
                                            sunGravitationalParameter,
                                            1171.64503236,
                                            1000.0,
