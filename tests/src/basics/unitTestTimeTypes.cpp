...
BOOST_AUTO_TEST_CASE( testTimeBasicCasts )
{
    ...
    {
        BOOST_CHECK_CLOSE_FRACTION( testTime.getSeconds< long double >( ),
                                    2.0L * TIME_NORMALIZATION_TERM + LONG_PI,
                                    std::numeric_limits< long double >::epsilon( ) );
        BOOST_CHECK_CLOSE_FRACTION(
                testTime.getSeconds< double >( ), 2.0 * TIME_NORMALIZATION_TERM + PI, std::numeric_limits< double >::epsilon( ) );

        BOOST_CHECK_CLOSE_FRACTION( static_cast< long double >( testTime ),
                                    2.0L * TIME_NORMALIZATION_TERM + LONG_PI,
                                    std::numeric_limits< long double >::epsilon( ) );
        BOOST_CHECK_CLOSE_FRACTION(
    ...
    // Test if Time pre-/post-multiplies Eigen vectors at expected level of precision
    {
        ...
        {
            BOOST_CHECK_CLOSE_FRACTION(
                    multipliedTestVector( i ), multipliedTestVectorLong( i ), std::numeric_limits< double >::epsilon( ) );
            BOOST_CHECK_CLOSE_FRACTION( 4.5L * ( 2.0L * TIME_NORMALIZATION_TERM + LONG_PI ),
                                        multipliedTestVectorLong( i ),
                                        std::numeric_limits< long double >::epsilon( ) );
        }
...
BOOST_AUTO_TEST_CASE( testTimeContentsPrecision )
{
    ...
    BOOST_CHECK_CLOSE_FRACTION(
            testTime.getSecondsIntoFullPeriod( ), LONG_PI, TIME_NORMALIZATION_TERM * std::numeric_limits< long double >::epsilon( ) );
    ...
    BOOST_CHECK_CLOSE_FRACTION(
            testTime2.getSecondsIntoFullPeriod( ), LONG_PI, TIME_NORMALIZATION_TERM * std::numeric_limits< long double >::epsilon( ) );
    ...
    BOOST_CHECK_CLOSE_FRACTION( testTime4.getSecondsIntoFullPeriod( ),
                                TIME_NORMALIZATION_TERM - LONG_PI,
...
{
    {
        ...
        // Test Time additions
        {
            ...
            BOOST_CHECK_CLOSE_FRACTION(
                    numberOfSeconds1 + numberOfSeconds2 - static_cast< long double >( correctionPeriods ) * TIME_NORMALIZATION_TERM,
        ...
        // Test addition between doubles and Time
        {
            ...
            BOOST_CHECK_EQUAL( numberOfDays1 + numberOfDays2 + correctionPeriods, outputTime.getFullPeriods( ) );
            BOOST_CHECK_CLOSE_FRACTION(
                    numberOfSeconds1 + ( inputLongDouble2 - static_cast< long double >( numberOfDays2 ) * TIME_NORMALIZATION_TERM ) -
        ...
        // Test subtraction between doubles and Time
        {
            ...
            BOOST_CHECK_EQUAL( numberOfDays2 - numberOfDays1 - correctionPeriodsDifference, outputTime.getFullPeriods( ) );
            BOOST_CHECK_CLOSE_FRACTION(
                    numberOfSeconds2 - ( inputLongDouble1 - static_cast< long double >( numberOfDays1 ) * TIME_NORMALIZATION_TERM ) +
                            static_cast< long double >( correctionPeriodsDifference ) * TIME_NORMALIZATION_TERM,
                    outputTime.getSecondsIntoFullPeriod( ),
                    std::numeric_limits< long double >::epsilon( ) );
            ...
            outputTime = inputLongDouble2 - inputTime1;
            BOOST_CHECK_EQUAL( numberOfDays2 - numberOfDays1 - correctionPeriodsDifference, outputTime.getFullPeriods( ) );
            BOOST_CHECK_CLOSE_FRACTION( ( inputLongDouble2 - static_cast< long double >( numberOfDays2 ) * TIME_NORMALIZATION_TERM ) -
                                                numberOfSeconds1 +
                                                static_cast< long double >( correctionPeriodsDifference ) * TIME_NORMALIZATION_TERM,
                                        outputTime.getSecondsIntoFullPeriod( ),
                                        std::numeric_limits< long double >::epsilon( ) );
    ...
    // Test division of Time by double/long double values
    {
        ...
        BOOST_CHECK_CLOSE_FRACTION(
                dividedTime.getSecondsIntoFullPeriod( ), LONG_PI / 2.0L, 2.0 * std::numeric_limits< long double >::epsilon( ) );

        dividedTime = testTime / 2.0;
        BOOST_CHECK_EQUAL( dividedTime.getFullPeriods( ), 1 );
        BOOST_CHECK_CLOSE_FRACTION(
                dividedTime.getSecondsIntoFullPeriod( ), LONG_PI / 2.0L, 2.0 * std::numeric_limits< double >::epsilon( ) );
        ...
        BOOST_CHECK_CLOSE_FRACTION(
                dividedTime.getSecondsIntoFullPeriod( ), LONG_PI * 8.0L / 3.0L, 2.0 * std::numeric_limits< long double >::epsilon( ) );
        dividedTime = testTime / 3.0;
        BOOST_CHECK_EQUAL( dividedTime.getFullPeriods( ), 3 );
        BOOST_CHECK_CLOSE_FRACTION(
                dividedTime.getSecondsIntoFullPeriod( ), LONG_PI * 8.0L / 3.0L, 2.0 * std::numeric_limits< double >::epsilon( ) );
    }
    ...
    // Test multiplication of Time by double/long double values
    {
        ...
        BOOST_CHECK_CLOSE_FRACTION(
                multipliedTime.getSecondsIntoFullPeriod( ), LONG_PI * 3.0L, 200.0 * std::numeric_limits< long double >::epsilon( ) );
        ...
        BOOST_CHECK_EQUAL( multipliedTime.getFullPeriods( ), 16 );
        BOOST_CHECK_CLOSE_FRACTION(
                multipliedTime.getSecondsIntoFullPeriod( ), PI * 3.0, TIME_NORMALIZATION_TERM * std::numeric_limits< double >::epsilon( ) );
...
BOOST_AUTO_TEST_CASE( testComparisonOperators )
{
    for( unsigned int i = 0; i < 4; i++ )
    {
        ...
        long double testTimeLongDouble2Rounded = testTimeLongDouble2 * ( 1.0L + 2.0L * std::numeric_limits< long double >::epsilon( ) );
