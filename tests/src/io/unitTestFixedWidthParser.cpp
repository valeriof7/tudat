...
#include "tudat/io/fixedWidthParser.h"
...
BOOST_AUTO_TEST_CASE( testFixedWidthParserSingleLine )
{
    ...
    input_output::FixedWidthParser testFixedWidthParser( 9,
                                                         general::name,
                                                         time::epoch,
    ...
    BOOST_CHECK_EQUAL( testLineData->find( state::periapsisDistance )->second->getRaw( ), "1.50908111" );
    BOOST_CHECK_EQUAL( testLineData->find( state::eccentricity )->second->getRaw( ), "0.51694646" );
    BOOST_CHECK_EQUAL( testLineData->find( state::inclination )->second->getRaw( ), "10.52513" );
    BOOST_CHECK_EQUAL( testLineData->find( state::argumentOfPeriapsis )->second->getRaw( ), "178.92837" );
    BOOST_CHECK_EQUAL( testLineData->find( state::longitudeOfAscendingNode )->second->getRaw( ), "68.92947" );
    BOOST_CHECK_EQUAL( testLineData->find( state::timeOfPeriapsisPassage )->second->getRaw( ), "20110112.22958" );
...
BOOST_AUTO_TEST_CASE( testFixedWidthParserMultiLineWithoutTrim )
{
    ...
    input_output::FixedWidthParser testFixedWidthParser( 8,
                                                         general::id,
                                                         state::semiMajorAxis,
                                                         state::eccentricity,
                                                         state::inclination,
    ...
    // Create test data.
    std::string testString(
            "2011542          3.9501468       0.2391642         6.87574        "
    ...
    BOOST_CHECK_EQUAL( Line1Data->find( state::semiMajorAxis )->second->getRaw( ), "      3.9501468   " );
    BOOST_CHECK_EQUAL( Line1Data->find( state::eccentricity )->second->getRaw( ), "    0.2391642     " );
    BOOST_CHECK_EQUAL( Line1Data->find( state::inclination )->second->getRaw( ), "    6.87574    " );
    BOOST_CHECK_EQUAL( Line1Data->find( state::longitudeOfAscendingNode )->second->getRaw( ), "    16.88982    " );
    BOOST_CHECK_EQUAL( Line1Data->find( state::argumentOfPeriapsis )->second->getRaw( ), "     48.9603   " );
    BOOST_CHECK_EQUAL( Line1Data->find( state::meanAnomaly )->second->getRaw( ), "    229.49648    " );
    ...
    BOOST_CHECK_EQUAL( Line2Data->find( state::semiMajorAxis )->second->getRaw( ), "      3.9619932   " );
    BOOST_CHECK_EQUAL( Line2Data->find( state::eccentricity )->second->getRaw( ), "     0.227483     " );
    BOOST_CHECK_EQUAL( Line2Data->find( state::inclination )->second->getRaw( ), "    9.22988    " );
    BOOST_CHECK_EQUAL( Line2Data->find( state::longitudeOfAscendingNode )->second->getRaw( ), "    58.20488    " );
    BOOST_CHECK_EQUAL( Line2Data->find( state::argumentOfPeriapsis )->second->getRaw( ), "   307.19412   " );
    BOOST_CHECK_EQUAL( Line2Data->find( state::meanAnomaly )->second->getRaw( ), "    201.38868    " );
