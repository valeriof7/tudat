...
BOOST_AUTO_TEST_CASE( testSofaFundamentalArguments )
{
    ...
    Eigen::Matrix< double, 5, 5 > conversionMatrixComparison = delaunayToDoodsonArguments - doodsonToDelaunayArguments.inverse( );
    ...
    double testSecondsSinceJ2000 =
            ( testModifiedJulianDay1 - ( -basic_astrodynamics::JULIAN_DAY_AT_0_MJD + basic_astrodynamics::JULIAN_DAY_ON_J2000 ) ) *
            physical_constants::JULIAN_DAY;
    Eigen::Matrix< double, 5, 1 > expectedFundamentalArgumentValues;
    expectedFundamentalArgumentValues << 2.291187512612069099, 6.212931111003726414, 3.658025792050572989, 4.554139562402433228,
    ...
    double expectedGmst = calculateGreenwichMeanSiderealTime( testSecondsSinceJ2000,
