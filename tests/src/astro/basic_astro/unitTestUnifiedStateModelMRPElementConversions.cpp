...
BOOST_AUTO_TEST_CASE( testconvertKeplerianToUnifiedStateModelModifiedRodriguesParametersElements )
{
    ...
    // Case 6: 180 inclination orbit.
    {
        ...
        expectedUnifiedStateModelElements( sigma3USM6Index ) = expectedUnifiedStateModelElements( sigma3USM6Index ) + 1.0;
        computedUnifiedStateModelElements( sigma3USM6Index ) = computedUnifiedStateModelElements( sigma3USM6Index ) + 1.0;
