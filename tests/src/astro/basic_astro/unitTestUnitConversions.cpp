...
BOOST_AUTO_TEST_CASE( testConversionFromKilometersToMeters )
{
    BOOST_CHECK_CLOSE_FRACTION(
            unit_conversions::convertKilometersToMeters( 1.0e6 ), 1.0e6 * 1.0e3, std::numeric_limits< double >::epsilon( ) );
}

//! Test conversion from degrees to radians.
BOOST_AUTO_TEST_CASE( testConversionFromDegreesToRadians )
{
    BOOST_CHECK_CLOSE_FRACTION( unit_conversions::convertDegreesToRadians( 45.0 ),
...
{
    BOOST_CHECK_CLOSE_FRACTION(
            unit_conversions::convertDegreesToArcminutes( 43.2 ), 43.2 * 60.0, std::numeric_limits< double >::epsilon( ) );
}
...
{
    BOOST_CHECK_CLOSE_FRACTION(
            unit_conversions::convertArcminutesToArcseconds( 125.9 ), 125.9 * 60.0, std::numeric_limits< double >::epsilon( ) );
}
...
BOOST_AUTO_TEST_CASE( testConversionFromAstronomicalUnitsToMeters )
{
    ...
    BOOST_CHECK_CLOSE_FRACTION( unit_conversions::convertAstronomicalUnitsToMeters( 30.10366151 ), 4.503443661e+12, 1.0e-9 );
}

//! Test conversion from minutes to seconds.
BOOST_AUTO_TEST_CASE( testConversionFromMinutesToSeconds )
{
    BOOST_CHECK_CLOSE_FRACTION( unit_conversions::convertMinutesToSeconds( 12.0 ), 12.0 * 60.0, std::numeric_limits< double >::epsilon( ) );
}

//! Test conversion from seconds to minutes.
BOOST_AUTO_TEST_CASE( testConversionFromSecondsToMinutes )
{
    BOOST_CHECK_CLOSE_FRACTION( unit_conversions::convertSecondsToMinutes( 12.0 ), 0.2, std::numeric_limits< double >::epsilon( ) );
}
...
BOOST_AUTO_TEST_CASE( testConversionFromHoursToJulianYears )
{
    ...
    BOOST_CHECK_CLOSE_FRACTION( convertJulianDaysToJulianYears( convertSecondsToJulianDays( convertHoursToSeconds( 24.0 ) ) ),
                                1.0 / 365.25,
                                std::numeric_limits< double >::epsilon( ) );
}
...
BOOST_AUTO_TEST_CASE( testConversionFromJulianYearsToHours )
{
    ...
    BOOST_CHECK_CLOSE_FRACTION( convertSecondsToHours( convertJulianDaysToSeconds( convertJulianYearsToJulianDays( 1.0 / 365.25 ) ) ),
                                24.0,
                                std::numeric_limits< double >::epsilon( ) );
}
...
{
    BOOST_CHECK_CLOSE_FRACTION( unit_conversions::convertSiderealDaysToSeconds( 7.0 ),
...
{
    BOOST_CHECK_CLOSE_FRACTION( unit_conversions::convertSecondsToSiderealDays( 100.0 ),
                                100.0 / physical_constants::SIDEREAL_DAY,
                                std::numeric_limits< double >::epsilon( ) );
}
...
BOOST_AUTO_TEST_CASE( testConversionFromRankineToKelvin )
{
    ...
    BOOST_CHECK_CLOSE_FRACTION( unit_conversions::convertRankineToKelvin( 491.67 ), 273.15, std::numeric_limits< double >::epsilon( ) );
}
...
BOOST_AUTO_TEST_CASE( testConversionFromFeetToMeters )
{
    ...
    BOOST_CHECK_CLOSE_FRACTION( unit_conversions::convertFeetToMeter( 5280.0 ), 1609.344, std::numeric_limits< double >::epsilon( ) );
}
...
BOOST_AUTO_TEST_CASE( testConversionFromPoundsPerSquareFeetToPascal )
{
    ...
    BOOST_CHECK_CLOSE_FRACTION( unit_conversions::convertPoundPerSquareFeetToPascal( 2116.21662367394 ), 101325.0, 1.0e-9 );
}
