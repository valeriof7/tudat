...
BOOST_AUTO_TEST_CASE( testGeneralCoordinateConversions )
{
    ...
    {
        computedCartesianPosition = coordinate_conversions::convertPositionElements( testGeodeticPosition,
                                                                                     coordinate_conversions::geodetic_position,
                                                                                     coordinate_conversions::cartesian_position,
                                                                                     oblateSpheroidModel );

        computedSphericalPosition = coordinate_conversions::convertPositionElements( testGeodeticPosition,
                                                                                     coordinate_conversions::geodetic_position,
    ...
    {
        computedSphericalPosition = coordinate_conversions::convertPositionElements( testCartesianPosition,
                                                                                     coordinate_conversions::cartesian_position,
                                                                                     coordinate_conversions::spherical_position,
                                                                                     oblateSpheroidModel );

        computedGeodeticPosition = coordinate_conversions::convertPositionElements( testCartesianPosition,
                                                                                    coordinate_conversions::cartesian_position,
                                                                                    coordinate_conversions::geodetic_position,
                                                                                    oblateSpheroidModel );
    ...
    {
        computedCartesianPosition = coordinate_conversions::convertPositionElements( testSphericalPosition,
                                                                                     coordinate_conversions::spherical_position,
                                                                                     coordinate_conversions::cartesian_position,
                                                                                     oblateSpheroidModel );

        computedGeodeticPosition = coordinate_conversions::convertPositionElements( testSphericalPosition,
                                                                                    coordinate_conversions::spherical_position,
                                                                                    coordinate_conversions::geodetic_position,
                                                                                    oblateSpheroidModel );
