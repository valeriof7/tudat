...
BOOST_AUTO_TEST_CASE( testSpecularDiffuseMix_ReflectedFraction_PointingAwayFromSource )
{
    ...
    const auto actualReflectedFraction = reflectionLaw.evaluateReflectedFraction( normal, incomingDirection, observerDirection );
...
BOOST_AUTO_TEST_CASE( testLambertian_ReflectedFraction )
{
    ...
    auto actualReflectedFraction = reflectionLaw.evaluateReflectedFraction( normal, incomingDirection, observerDirection );
    ...
    actualReflectedFraction = reflectionLaw.evaluateReflectedFraction( normal, incomingDirection, observerDirection );
