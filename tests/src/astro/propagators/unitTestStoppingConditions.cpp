    ...
    switch( testType )
    {
        ...
        case 1:
            terminationSettings = std::make_shared< propagators::PropagationDependentVariableTerminationSettings >(
                    std::make_shared< propagators::SingleDependentVariableSaveSettings >( propagators::mach_number_dependent_variable,
                                                                                          "Apollo" ),
                    3.0,
                    1 );
            break;
        ...
        case 2:
            terminationSettings = std::make_shared< propagators::PropagationDependentVariableTerminationSettings >(
                    std::make_shared< propagators::SingleDependentVariableSaveSettings >( propagators::altitude_dependent_variable,
                                                                                          "Apollo" ),
                    10.0E3,
                    1 );
            break;
        ...
        case 3:
            terminationSettings = std::make_shared< propagators::PropagationDependentVariableTerminationSettings >(
                    std::make_shared< propagators::SingleDependentVariableSaveSettings >( propagators::local_density_dependent_variable,
                                                                                          "Apollo" ),
                    1.1,
                    0 );
            break;
        ...
        case 4: {
            ...
            terminationSettings = std::make_shared< propagators::PropagationHybridTerminationSettings >( constituentSettings, 1 );
            break;
        }
        ...
        case 5: {
            ...
            terminationSettings = std::make_shared< propagators::PropagationHybridTerminationSettings >( constituentSettings, 0 );
            break;
        }
    }
...
void performSimulation( const int testType )
{
    ...
    switch( testType )
    {
        ...
        case 0: {
            BOOST_CHECK_EQUAL(
                    ( ( --( numericalSolution.end( ) ) )->first >= 3200.0 ) && ( ( --( --( numericalSolution.end( ) ) ) )->first < 3200.0 ),
                    true );
            break;
        }
        case 1: {
            ...
            stateDerivativeModel->computeStateDerivative( ( --( --( numericalSolution.end( ) ) ) )->first,
                                                          ( --( --( numericalSolution.end( ) ) ) )->second );
        ...
        case 5: {
            ...
            BOOST_CHECK_EQUAL( ( ( ( --( numericalSolution.end( ) ) )->first >= 3200.0 ) ) && ( ( lastMachNumber <= 3.0 ) ) &&
                                       ( ( lastAltitude <= 10.0E3 ) ) && ( ( lastDensity >= 1.1 ) ),
                               1 );

            BOOST_CHECK_EQUAL( ( ( --( --( numericalSolution.end( ) ) ) )->first < 3200.0 ) || ( ( secondToLastMachNumber > 3.0 ) ) ||
                                       ( ( secondToLastAltitude > 10.0E3 ) ) || ( ( secondToLastDensity < 1.1 ) ),
                               1 );
...
BOOST_AUTO_TEST_CASE( testPropagationStoppingConditionsWithDependentVariableUpdate )
{
    ...
    BOOST_CHECK_EQUAL( ( stateIterator->second.segment( 0, 3 ).norm( ) - tudat::spice_interface::getAverageRadius( "Earth" ) ) < 25.0E3,
                       true );
    stateIterator++;
    BOOST_CHECK_EQUAL( ( stateIterator->second.segment( 0, 3 ).norm( ) - tudat::spice_interface::getAverageRadius( "Earth" ) ) < 25.0E3,
                       false );
