...
BOOST_AUTO_TEST_CASE( testHybridArcMultiBodyVariationalEquationCalculation1 )
{
    ...
    for( unsigned int testCase = 1; testCase < 2; testCase++ )
    {
        ...
        singleArcParameterNames.push_back( std::make_shared< InitialTranslationalStateEstimatableParameterSettings< double > >(
        ...
        {
            multiArcParameterNames.push_back( std::make_shared< ArcWiseInitialTranslationalStateEstimatableParameterSettings< double > >(
                    listBodiesToPropagate[ i ],
                    multiArcInitialStatesPerBody.at( listBodiesToPropagate[ i ] ),
        ...
        //                    std::cout << hybridArcVariationalEquationsSolver.getStateTransitionMatrixInterface(
        //                    )->getCombinedStateTransitionAndSensitivityMatrix(
        //                            ( arcStartTimes[ 0 ] + multiArcEndTimes[ 0 ] ) / 2.0 ) << "\n\n";
        //                    std::cout << "single-arc solution" << "\n\n";
        //                    std::cout <<
        //                    hybridArcVariationalEquationsSolver.getSingleArcSolver()->getStateTransitionMatrixInterface()->getCombinedStateTransitionAndSensitivityMatrix(
        //                            ( arcStartTimes[ 0 ] + multiArcEndTimes[ 0 ] ) / 2.0 ) << "\n\n";
        ...
        std::shared_ptr< interpolators::LagrangeInterpolator< double, Eigen::MatrixXd > > singleArcStateTransitionMatrixInterpolator =
                std::make_shared< interpolators::LagrangeInterpolator< double, Eigen::MatrixXd > >(
                        ...
                        utilities::createVectorFromMapValues< Eigen::MatrixXd, double >( singleArcVariationalSolution[ 0 ] ),
                        4 );
        std::shared_ptr< interpolators::LagrangeInterpolator< double, Eigen::MatrixXd > > singleArcSensitivityMatrixInterpolator =
                std::make_shared< interpolators::LagrangeInterpolator< double, Eigen::MatrixXd > >(
                        ...
                        utilities::createVectorFromMapValues< Eigen::MatrixXd, double >( singleArcVariationalSolution[ 1 ] ),
                        4 );
        ...
        std::shared_ptr< interpolators::LagrangeInterpolator< double, Eigen::MatrixXd > > multiArc0StateTransitionMatrixInterpolator =
                std::make_shared< interpolators::LagrangeInterpolator< double, Eigen::MatrixXd > >(
                        ...
                        utilities::createVectorFromMapValues< Eigen::MatrixXd, double >( fullMultiArcVariationalSolution[ 0 ][ 0 ] ),
                        4 );
        std::shared_ptr< interpolators::LagrangeInterpolator< double, Eigen::MatrixXd > > multiArc0SensitivityMatrixInterpolator =
                std::make_shared< interpolators::LagrangeInterpolator< double, Eigen::MatrixXd > >(
                        ...
                        utilities::createVectorFromMapValues< Eigen::MatrixXd, double >( fullMultiArcVariationalSolution[ 0 ][ 1 ] ),
                        4 );
        ...
        //                                                                       true, std::shared_ptr<
        //                                                                       numerical_integrators::IntegratorSettings< double > >( ),
        //                                                                       false, true, true );
        //
        //        MultiArcVariationalEquationsSolver< double, double > multiArcVariationalEquationsSolverTest =
        //                MultiArcVariationalEquationsSolver< double, double >( bodies, integratorSettings, multiArcPropagatorSettings,
        //                multiArcParametersToEstimate, arcStartTimes,
        //                                                                      true, std::shared_ptr<
        //                                                                      numerical_integrators::IntegratorSettings< double > >( ),
        //                                                                      false, true, false );
        //
        ...
        //
        //        std::map< double, Eigen::MatrixXd > singleArcSTM =
        //        singleArcVariationalEquationsSolver->getNumericalVariationalEquationsSolution( )[ 0 ];
        ...
        //        singleArcVariationalEquationsSolverTest.getNumericalVariationalEquationsSolution( )[ 0 ]; std::cout << "last element
        //        single-arc STM history: " << "\n\n"; std::cout << singleArcSTM.rbegin( )->second << "\n\n"; std::cout << "last element
        //        single-arc STM history TEST: " << "\n\n"; std::cout << singleArcStmTest.rbegin( )->second << "\n\n";
        //
        //        std::map< double, Eigen::MatrixXd > multiArcStmArc1 =
        //        multiArcVariationalEquationsSolver->getNumericalVariationalEquationsSolution( )[ 0 ][ 0 ]; std::map< double,
        //        Eigen::MatrixXd > multiArcStmArc3 = multiArcVariationalEquationsSolver->getNumericalVariationalEquationsSolution( )[ 2 ][
        //        0 ]; std::cout << "last element multi-arc (arc 1) STM history: " << "\n\n"; std::cout << multiArcStmArc1.rbegin( )->second
        //        << "\n\n";

        //        std::map< double, Eigen::MatrixXd > multiArcStmArc1Test =
        //        multiArcVariationalEquationsSolverTest.getNumericalVariationalEquationsSolution( )[ 0 ][ 0 ]; std::map< double,
        //        Eigen::MatrixXd > multiArcStmArc3Test = multiArcVariationalEquationsSolverTest.getNumericalVariationalEquationsSolution(
        //        )[ 2 ][ 0 ]; std::cout << "last element multi-arc (arc 1) STM history: " << "\n\n"; std::cout <<
        //        multiArcStmArc1Test.rbegin( )->second << "\n\n";
        //
        ...
        //                    itr.second, singleArcVariationalEquationsSolverTest.getNumericalVariationalEquationsSolution( )[ 0 ].at(
        //                    itr.first ), 1.0E-12 );
        //            TUDAT_CHECK_MATRIX_CLOSE_FRACTION(
        ...
        //                        );
        //                TUDAT_CHECK_MATRIX_CLOSE_FRACTION(
        //                        sensitivityMatrixFromHybridSolution.block( 6, 6, sensitivityMatrixFromHybridSolution.rows( ) - 6,
        //                        sensitivityMatrixFromHybridSolution.cols( ) - 6 ),
        //                        multiArcVariationalEquationsSolverTest.getNumericalVariationalEquationsSolution( )[ k ][ 1 ].at( itr.first
        //                        ), 1.0E-12 );
        //
        //
