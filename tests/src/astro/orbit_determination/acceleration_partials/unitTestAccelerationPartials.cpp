...
BOOST_AUTO_TEST_CASE( testPanelledRadiationPressureAccelerationPartials )
{
    ...
    for( int testIndex = 0; testIndex < 7; testIndex++ )
    {
        ...
        vehicle->setState( ( Eigen::Vector6d( ) << 1.4E11, 1.0E11, 1.1E11, 0.0, 0.0, 0.0 )
                                   .finished( ) );  // getBodyCartesianStateAtEpoch(  "Earth", "SSB", "J2000", "NONE", 1.0E6 ) );
        ...
        if( testIndex < 6 )
        {
            ...
            panelSettingsList.push_back( std::make_shared< BodyPanelSettings >(
                    ...
                    std::make_shared< SpecularDiffuseBodyPanelReflectionLawSettings >(
                            specularReflectivity, diffuseReflectivity, useInstantaneousReradiation ),
                    "SolarPanel" ) );
            if( testIndex > 2 )
            {
                panelSettingsList.push_back( std::make_shared< BodyPanelSettings >(
                ...
                panelSettingsList.push_back( std::make_shared< BodyPanelSettings >(
                        ...
                        std::make_shared< SpecularDiffuseBodyPanelReflectionLawSettings >(
                                scalingValue * specularReflectivity, scalingValue * diffuseReflectivity, useInstantaneousReradiation ),
                        panelName ) );
                panelSettingsList.push_back( std::make_shared< BodyPanelSettings >(
        ...
        else
        {
            panelSettingsList.push_back(
                    std::make_shared< BodyPanelSettings >( bodyTrackingPanelGeometry( "Sun", true, 1.0 ),
                                                           std::make_shared< SpecularDiffuseBodyPanelReflectionLawSettings >(
                                                                   specularReflectivity, diffuseReflectivity, useInstantaneousReradiation ),
                                                           "SolarPanel" ) );
            panelSettingsList.push_back(
                    std::make_shared< BodyPanelSettings >( bodyTrackingPanelGeometry( "Sun", false, 1.346 ),
                                                           std::make_shared< SpecularDiffuseBodyPanelReflectionLawSettings >(
                                                                   specularReflectivity, diffuseReflectivity, useInstantaneousReradiation ),
                                                           "SolarPanel" ) );
        }
        ...
        std::shared_ptr< RadiationPressureAcceleration > accelerationModel = std::dynamic_pointer_cast< RadiationPressureAcceleration >(
                createRadiationPressureAccelerationModel( vehicle, sun, "Vehicle", "Sun", bodies ) );
        ...
        testPartialWrtDiffuseReflectivity =
                calculateAccelerationWrtParameterPartials( diffuseReflectivityParameter, accelerationModel, 0.1, updateFunction );
        testPartialWrtSpecularReflectivity =
        ...
        TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtSunVelocity, partialWrtSunVelocity, std::numeric_limits< double >::epsilon( ) );
        TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtVehiclePosition, partialWrtVehiclePosition, 1.0e-6 );
        TUDAT_CHECK_MATRIX_CLOSE_FRACTION(
                testPartialWrtVehicleVelocity, partialWrtVehicleVelocity, std::numeric_limits< double >::epsilon( ) );
        TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtParallelScaling, partialWrtParallelScaling, 1.0E-13 );
        TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtPerpendicularScaling, partialWrtPerpendicularScaling, 1.0E-13 );
        TUDAT_CHECK_MATRIX_CLOSE_FRACTION( partialWrtSpecularReflectivity, testPartialWrtSpecularReflectivity, 1.0E-8 );
        if( testIndex % 2 == 0 )
        {
            TUDAT_CHECK_MATRIX_CLOSE_FRACTION( partialWrtDiffuseReflectivity, testPartialWrtDiffuseReflectivity, 1.0E-13 );
        }
        else
        {
...
BOOST_AUTO_TEST_CASE( testCentralGravityPartials )
{
    ...
    std::shared_ptr< GravityFieldModel > sunGravityFieldModel = std::make_shared< GravityFieldModel >( sunsGravitationalParameter );
    sun->setGravityFieldModel( sunGravityFieldModel );
    double earthGravitationalParameter = getBodyGravitationalParameter( "Earth" );
    std::shared_ptr< GravityFieldModel > earthGravityFieldModel = std::make_shared< GravityFieldModel >( earthGravitationalParameter );
    ...
    std::shared_ptr< AccelerationPartial > centralGravitationPartial = createAnalyticalAccelerationPartial(
            gravitationalAcceleration, std::make_pair( "Earth", earth ), std::make_pair( "Sun", sun ), bodies );

    // Create gravitational parameter object.
    std::shared_ptr< EstimatableParameter< double > > sunGravitationalParameterParameter =
            std::make_shared< GravitationalParameter >( sunGravityFieldModel, "Sun" );
    std::shared_ptr< EstimatableParameter< double > > earthGravitationalParameterParameter =
            std::make_shared< GravitationalParameter >( earthGravityFieldModel, "Earth" );
    ...
    Eigen::Vector3d partialWrtSunGravitationalParameter = centralGravitationPartial->wrtParameter( sunGravitationalParameterParameter );
    Eigen::Vector3d partialWrtEarthGravitationalParameter = centralGravitationPartial->wrtParameter( earthGravitationalParameterParameter );
    ...
    Eigen::Vector3d testPartialWrtSunGravitationalParameter =
            calculateAccelerationWrtParameterPartials( sunGravitationalParameterParameter, gravitationalAcceleration, 1.0E12 );
    Eigen::Vector3d testPartialWrtEarthGravitationalParameter =
            calculateAccelerationWrtParameterPartials( earthGravitationalParameterParameter, gravitationalAcceleration, 1.0E12 );

    // Compare numerical and analytical results.
    TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtEarthPosition, partialWrtEarthPosition, 1.0E-8 );

    TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtEarthVelocity, partialWrtEarthVelocity, std::numeric_limits< double >::epsilon( ) );
    TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtSunPosition, partialWrtSunPosition, 1.0E-8 );
    TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtSunVelocity, partialWrtSunVelocity, std::numeric_limits< double >::epsilon( ) );
    TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtSunGravitationalParameter, partialWrtSunGravitationalParameter, 1.0E-6 );
    TUDAT_CHECK_MATRIX_CLOSE_FRACTION( partialWrtEarthGravitationalParameter, testPartialWrtEarthGravitationalParameter, 1.0E-6 );
    TUDAT_CHECK_MATRIX_CLOSE_FRACTION(
...
BOOST_AUTO_TEST_CASE( testCannonballRadiationPressureAccelerationPartials )
{
    ...
    // Create partial-calculating object.
    std::shared_ptr< AccelerationPartial > accelerationPartial = createAnalyticalAccelerationPartial(
    ...
    Eigen::Vector3d partialWrtRadiationPressureCoefficient = accelerationPartial->wrtParameter( radiationPressureCoefficient );
    Eigen::Vector3d partialWrtScalingFactor = accelerationPartial->wrtParameter( radiationPressureScalingSourceDirection );

    // Get arc-wise radiation pressure coefficient partials
    Eigen::MatrixXd partialWrtRadiationPressureCoefficientArcwise =
            accelerationPartial->wrtParameter( arcWiseRadiationPressureCoefficient );
    currentTime = 1000.0;
    accelerationPartial->update( currentTime );
    Eigen::MatrixXd partialWrtRadiationPressureCoefficientArcwise2 =
            accelerationPartial->wrtParameter( arcWiseRadiationPressureCoefficient );
    currentTime = 4000.0;
    accelerationPartial->update( currentTime );
    Eigen::MatrixXd partialWrtRadiationPressureCoefficientArcwise3 =
            accelerationPartial->wrtParameter( arcWiseRadiationPressureCoefficient );
    currentTime = 7000.0;
    accelerationPartial->update( currentTime );
    Eigen::MatrixXd partialWrtRadiationPressureCoefficientArcwise4 =
            accelerationPartial->wrtParameter( arcWiseRadiationPressureCoefficient );
    currentTime = 10000.0;
    accelerationPartial->update( currentTime );
    Eigen::MatrixXd partialWrtRadiationPressureCoefficientArcwise5 =
            accelerationPartial->wrtParameter( arcWiseRadiationPressureCoefficient );
    currentTime = 12000.0;
    accelerationPartial->update( currentTime );
    Eigen::MatrixXd partialWrtRadiationPressureCoefficientArcwise6 =
            accelerationPartial->wrtParameter( arcWiseRadiationPressureCoefficient );
    ...
    for( unsigned int i = 0; i < 3; i++ )
    {
        for( unsigned int j = 0; j < 4; j++ )
        {
            ...
            {
                BOOST_CHECK_SMALL(
                        std::fabs( partialWrtRadiationPressureCoefficientArcwise( i, j ) - partialWrtRadiationPressureCoefficient( i ) ),
                        1.0E-24 );
                BOOST_CHECK_SMALL(
                        std::fabs( partialWrtRadiationPressureCoefficientArcwise2( i, j ) - partialWrtRadiationPressureCoefficient( i ) ),
                        1.0E-24 );
            }
            ...
            {
                BOOST_CHECK_SMALL(
                        std::fabs( partialWrtRadiationPressureCoefficientArcwise3( i, j ) - partialWrtRadiationPressureCoefficient( i ) ),
                        1.0E-24 );
                BOOST_CHECK_SMALL(
                        std::fabs( partialWrtRadiationPressureCoefficientArcwise4( i, j ) - partialWrtRadiationPressureCoefficient( i ) ),
                        1.0E-24 );
            }
            ...
            {
                BOOST_CHECK_SMALL(
                        std::fabs( partialWrtRadiationPressureCoefficientArcwise5( i, j ) - partialWrtRadiationPressureCoefficient( i ) ),
                        1.0E-24 );
            }
            ...
            {
                BOOST_CHECK_SMALL(
                        std::fabs( partialWrtRadiationPressureCoefficientArcwise6( i, j ) - partialWrtRadiationPressureCoefficient( i ) ),
                        1.0E-24 );
            }
        }
    }
    ...
    Eigen::Vector3d testPartialWrtScalingFactor = Eigen::Vector3d::Zero( );
    ...
    testPartialWrtVehicleVelocity = calculateAccelerationWrtStatePartials(
            vehicleStateSetFunction, accelerationModel, vehicle->getState( ), velocityPerturbation, 3, updateFunction );
    testPartialWrtRadiationPressureCoefficient =
    ...
    TUDAT_CHECK_MATRIX_CLOSE_FRACTION(
            testPartialWrtVehicleVelocity, partialWrtVehicleVelocity, std::numeric_limits< double >::epsilon( ) );
    TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtRadiationPressureCoefficient, partialWrtRadiationPressureCoefficient, 1.0E-12 );
    TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtScalingFactor, partialWrtScalingFactor, 1.0E-12 );
}
...
BOOST_AUTO_TEST_CASE( testThirdBodyGravityPartials )
{
    ...
    std::shared_ptr< GravityFieldModel > moonGravityFieldModel = std::make_shared< GravityFieldModel >( moonsGravitationalParameter );
    ...
    std::shared_ptr< ThirdBodyCentralGravityAcceleration > gravitationalAcceleration =
            createThirdBodyCentralGravityAccelerationModel( moon, sun, earth, "Moon", "Sun", "Earth" );

    // Create central gravity partial.
    std::shared_ptr< AccelerationPartial > thirdBodyGravitationPartial = createAnalyticalAccelerationPartial(
            gravitationalAcceleration, std::make_pair( "Moon", moon ), std::make_pair( "Sun", sun ), bodies );

    // Create gravitational parameter object.
    std::shared_ptr< EstimatableParameter< double > > gravitationalParameterParameter =
            std::make_shared< GravitationalParameter >( sunGravityFieldModel, "Sun" );
    std::shared_ptr< EstimatableParameter< double > > moonGravitationalParameterParameter =
            std::make_shared< GravitationalParameter >( moonGravityFieldModel, "Moon" );
    std::shared_ptr< EstimatableParameter< double > > earthGravitationalParameterParameter =
            std::make_shared< GravitationalParameter >( earthGravityFieldModel, "Earth" );
    ...
    Eigen::MatrixXd partialWrtSunGravitationalParameter = thirdBodyGravitationPartial->wrtParameter( gravitationalParameterParameter );
    Eigen::MatrixXd partialWrtMoonGravitationalParameter = thirdBodyGravitationPartial->wrtParameter( moonGravitationalParameterParameter );
    Eigen::MatrixXd partialWrtEarthGravitationalParameter =
    ...
    testPartialWrtEarthVelocity = calculateAccelerationWrtStatePartials(
            earthStateSetFunction, gravitationalAcceleration, earth->getState( ), velocityPerturbation, 3 );
    Eigen::Vector3d testPartialWrtSunGravitationalParameter =
            calculateAccelerationWrtParameterPartials( gravitationalParameterParameter, gravitationalAcceleration, 1.0E16 );
    Eigen::Vector3d testPartialWrtEarthGravitationalParameter =
            calculateAccelerationWrtParameterPartials( earthGravitationalParameterParameter, gravitationalAcceleration, 1.0E16 );
    Eigen::Vector3d testPartialWrtMoonGravitationalParameter =
            calculateAccelerationWrtParameterPartials( moonGravitationalParameterParameter, gravitationalAcceleration, 1.0E16 );
    ...
    TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtSunPosition, partialWrtSunPosition, 1.0E-5 );
    TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtSunVelocity, partialWrtSunVelocity, std::numeric_limits< double >::epsilon( ) );
    TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtEarthPosition, partialWrtEarthPosition, 1.0E-5 );
    TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtEarthVelocity, partialWrtEarthVelocity, std::numeric_limits< double >::epsilon( ) );
    TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtSunGravitationalParameter, partialWrtSunGravitationalParameter, 1.0E-6 );
    TUDAT_CHECK_MATRIX_CLOSE_FRACTION(
            testPartialWrtMoonGravitationalParameter, partialWrtMoonGravitationalParameter, std::numeric_limits< double >::epsilon( ) );
    TUDAT_CHECK_MATRIX_CLOSE_FRACTION(
...
BOOST_AUTO_TEST_CASE( testAerodynamicAccelerationPartials )
{
    ...
    vehicleSphericalEntryState( SphericalOrbitalStateElementIndices::radiusIndex ) = spice_interface::getAverageRadius( "Earth" ) + 120.0E3;
    ...
    Eigen::Vector6d systemInitialState = tudat::ephemerides::transformStateToTargetFrame(
            convertSphericalOrbitalToCartesianState( vehicleSphericalEntryState ), 0.0, bodies.at( "Earth" )->getRotationalEphemeris( ) );
    ...
    testPartialWrtVehicleVelocity = calculateAccelerationWrtStatePartials( vehicleStateSetFunction,
                                                                           accelerationModel,
                                                                           bodies.at( "Vehicle" )->getState( ),
                                                                           velocityPerturbation,
                                                                           3,
                                                                           environmentUpdateFunction );
    testPartialWrtEarthPosition = calculateAccelerationWrtStatePartials( earthStateSetFunction,
                                                                         accelerationModel,
                                                                         bodies.at( "Earth" )->getState( ),
                                                                         positionPerturbation,
                                                                         0,
                                                                         environmentUpdateFunction );
    testPartialWrtEarthVelocity = calculateAccelerationWrtStatePartials( earthStateSetFunction,
                                                                         accelerationModel,
                                                                         bodies.at( "Earth" )->getState( ),
                                                                         velocityPerturbation,
                                                                         3,
...
BOOST_AUTO_TEST_CASE( testRelativisticAccelerationPartial )
{
    ...
    vehicleKeplerElements << 6378.0E3 + 249E3, 0.0004318, convertDegreesToRadians( 96.5975 ), convertDegreesToRadians( 217.6968 ),
            convertDegreesToRadians( 268.2663 ), convertDegreesToRadians( 142.3958 );
    vehicle->setState( earth->getState( ) +
                       convertKeplerianToCartesianElements( vehicleKeplerElements, getBodyGravitationalParameter( "Earth" ) ) );
    ...
    std::shared_ptr< RelativisticAccelerationPartial > accelerationPartial =
            std::make_shared< RelativisticAccelerationPartial >( accelerationModel, "Vehicle", "Earth" );

    // Create parameter objects.
    std::shared_ptr< EstimatableParameter< double > > gravitationalParameterParameter =
            std::make_shared< GravitationalParameter >( earthGravityField, "Earth" );
    std::shared_ptr< EstimatableParameter< double > > ppnParameterGamma = std::make_shared< PPNParameterGamma >( ppnParameterSet );
    std::shared_ptr< EstimatableParameter< double > > ppnParameterBeta = std::make_shared< PPNParameterBeta >( ppnParameterSet );
    ...
    Eigen::Vector3d partialWrtEarthGravitationalParameter = accelerationPartial->wrtParameter( gravitationalParameterParameter );
    ...
    Eigen::Matrix3d testPartialWrtEarthPosition =
            calculateAccelerationWrtStatePartials( earthStateSetFunction, accelerationModel, earth->getState( ), positionPerturbation, 0 );
    Eigen::Matrix3d testPartialWrtEarthVelocity =
            calculateAccelerationWrtStatePartials( earthStateSetFunction, accelerationModel, earth->getState( ), velocityPerturbation, 3 );
    Eigen::Vector3d testPartialWrtEarthGravitationalParameter =
            calculateAccelerationWrtParameterPartials( gravitationalParameterParameter, accelerationModel, 1.0E10 );
    Eigen::Vector3d testPartialWrtPpnParameterGamma =
            calculateAccelerationWrtParameterPartials( ppnParameterGamma, accelerationModel, 100.0 );
    Eigen::Vector3d testPartialWrtPpnParameterBeta =
            calculateAccelerationWrtParameterPartials( ppnParameterBeta, accelerationModel, 100.0 );

    // Compare numerical and analytical results.
    TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtEarthPosition, partialWrtEarthPosition, 1.0e-7 );

    TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtEarthVelocity, partialWrtEarthVelocity, 1.0e-7 );

    TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtVehiclePosition, partialWrtVehiclePosition, 1.0e-7 );

    TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtVehicleVelocity, partialWrtVehicleVelocity, 1.0e-7 );

    TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtEarthGravitationalParameter, partialWrtEarthGravitationalParameter, 1.0e-8 );
...
BOOST_AUTO_TEST_CASE( testEmpiricalAccelerationPartial )
{
    ...
    std::shared_ptr< EmpiricalAccelerationPartial > accelerationPartial =
            std::make_shared< EmpiricalAccelerationPartial >( accelerationModel, "Vehicle", "Earth" );
    ...
    std::shared_ptr< EmpiricalAccelerationCoefficientsParameter > empiricalAccelerationParameter =
            std::make_shared< EmpiricalAccelerationCoefficientsParameter >(
                    std::vector< std::shared_ptr< EmpiricalAcceleration > >( { accelerationModel } ),
                    "Vehicle",
                    "Earth",
                    empiricalComponentsToEstimate );

    {
        ...
        accelerationPartial->wrtEmpiricalAccelerationCoefficient( empiricalAccelerationParameter, partialWrtEmpiricalCoefficients );
        ...
        Eigen::MatrixXd testPartialWrtEmpiricalCoefficients =
                calculateAccelerationWrtParameterPartials( empiricalAccelerationParameter, accelerationModel, parameterPerturbation );
        ...
        TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtVehicleVelocity, partialWrtVehicleVelocity, 1.0e-3 );

        TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtEmpiricalCoefficients, partialWrtEmpiricalCoefficients, 1.0e-3 );
    }
    ...
    std::shared_ptr< ArcWiseEmpiricalAccelerationCoefficientsParameter > arcWiseEmpiricalAccelerationParameter =
            std::make_shared< ArcWiseEmpiricalAccelerationCoefficientsParameter >(
                    std::vector< std::shared_ptr< EmpiricalAcceleration > >( { accelerationModel } ),
                    "Vehicle",
                    "Earth",
                    empiricalComponentsToEstimate,
    ...
    for( unsigned int i = 0; i < evaluationTimes.size( ); i++ )
    {
        ...
        Eigen::MatrixXd partialWrtVehicleVelocity = Eigen::Matrix3d::Zero( );
        accelerationPartial->wrtVelocityOfAcceleratedBody( partialWrtVehicleVelocity.block( 0, 0, 3, 3 ) );
        Eigen::MatrixXd partialWrtEmpiricalCoefficients = accelerationPartial->wrtParameter( arcWiseEmpiricalAccelerationParameter );
        ...
        // Calculate numerical partials.
        Eigen::MatrixXd testPartialWrtVehiclePosition = calculateAccelerationWrtStatePartials( vehicleStateSetFunction,
                                                                                               accelerationModel,
                                                                                               vehicle->getState( ),
                                                                                               positionPerturbation,
                                                                                               0,
        ...
        Eigen::MatrixXd testPartialWrtVehicleVelocity = calculateAccelerationWrtStatePartials( vehicleStateSetFunction,
                                                                                               accelerationModel,
                                                                                               vehicle->getState( ),
                                                                                               velocityPerturbation,
                                                                                               3,
                                                                                               emptyFunction,
                                                                                               evaluationTimes.at( i ) );
        Eigen::MatrixXd testPartialWrtEarthPosition = calculateAccelerationWrtStatePartials( earthStateSetFunction,
                                                                                             accelerationModel,
                                                                                             earth->getState( ),
                                                                                             positionPerturbation,
                                                                                             0,
                                                                                             emptyFunction,
                                                                                             evaluationTimes.at( i ) );
        Eigen::MatrixXd testPartialWrtEarthVelocity = calculateAccelerationWrtStatePartials( earthStateSetFunction,
                                                                                             accelerationModel,
                                                                                             earth->getState( ),
                                                                                             velocityPerturbation,
                                                                                             3,
                                                                                             ...
                                                                                             evaluationTimes.at( i ) );
        Eigen::MatrixXd testPartialWrtEmpiricalCoefficients =
                calculateAccelerationWrtParameterPartials( arcWiseEmpiricalAccelerationParameter,
                                                           accelerationModel,
                                                           accelerationPerturbationVector,
                                                           emptyFunction,
                                                           evaluationTimes.at( i ) );
        ...
        TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtEmpiricalCoefficients, partialWrtEmpiricalCoefficients, 1.0e-6 );
    }
}
...
BOOST_AUTO_TEST_CASE( testDirectDissipationAccelerationPartial )
{
    ...
    Eigen::Vector6d ioKeplerElements = ( Eigen::Vector6d( ) << 1.0 * 421.8E6, 1.0 * 0.004, 0.001, 2.0, 3.0, 0.4 ).finished( );
    io->setState( convertKeplerianToCartesianElements(
            ioKeplerElements, getBodyGravitationalParameter( "Jupiter" ) + getBodyGravitationalParameter( "Io" ) ) );
    ...
    std::shared_ptr< GravityFieldSettings > jupiterGravityFieldSettings =
            std::make_shared< SphericalHarmonicsGravityFieldSettings >( getBodyGravitationalParameter( "Jupiter" ),
    ...
    std::shared_ptr< GravityFieldSettings > ioGravityFieldSettings = std::make_shared< SphericalHarmonicsGravityFieldSettings >(
            getBodyGravitationalParameter( "Io" ), getAverageRadius( "Io" ), cosineCoefficients, sineCoefficients, "IAU_Io" );
    std::shared_ptr< gravitation::GravityFieldModel > ioGravityField = createGravityFieldModel( ioGravityFieldSettings, "Io", bodies );
    io->setGravityFieldModel( ioGravityField );

    // Create rotation model
    std::shared_ptr< ephemerides::SimpleRotationalEphemeris > simpleRotationalEphemeris =
            std::make_shared< ephemerides::SimpleRotationalEphemeris >( Eigen::Quaterniond( Eigen::Matrix3d::Identity( ) ),
                                                                        2.0 * mathematical_constants::PI / ( 9.925 * 3600.0 ),
                                                                        0.0,
                                                                        "ECLIPJ2000",
                                                                        "IAU_Jupiter" );
    ...
    for( unsigned int useRadialTerm = 0; useRadialTerm < 2; useRadialTerm++ )
    {
        for( unsigned int usePlanetTide = 0; usePlanetTide < 2; usePlanetTide++ )
        {
            ...
            std::shared_ptr< gravitation::DirectTidalDissipationAcceleration > accelerationModel =
                    std::dynamic_pointer_cast< gravitation::DirectTidalDissipationAcceleration >( simulation_setup::createAccelerationModel(
                            io,
                            jupiter,
                            std::make_shared< simulation_setup::DirectTidalDissipationAccelerationSettings >(
                                    loveNumber, timeLag, bool( useRadialTerm ), bool( usePlanetTide ) ),
                            "Io",
                            "Jupiter" ) );
            ...
            std::shared_ptr< EstimatableParameter< double > > jupiterGravitationalParameterParameter =
                    std::make_shared< GravitationalParameter >( jupiterGravityField, "Jupiter" );
            std::shared_ptr< EstimatableParameter< double > > ioGravitationalParameterParameter =
                    std::make_shared< GravitationalParameter >( ioGravityField, "Io" );
...

            {
                ...
                Eigen::MatrixXd partialWrtJupiterGravitationalParameter =
                        accelerationPartial->wrtParameter( jupiterGravitationalParameterParameter );
                Eigen::MatrixXd partialWrtIoGravitationalParameter = accelerationPartial->wrtParameter( ioGravitationalParameterParameter );
                Eigen::MatrixXd partialWrtTidalTimeLag = accelerationPartial->wrtParameter( tidalTimeLagParameter );
                ...
                Eigen::MatrixXd testPartialWrtTidalTimeLag =
                        calculateAccelerationWrtParameterPartials( tidalTimeLagParameter, accelerationModel, timelagPerturbation );

                // Compare numerical and analytical results.
                TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtJupiterPosition, partialWrtJupiterPosition, 1.0e-5 );

                TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtJupiterVelocity, partialWrtJupiterVelocity, 1.0e-5 );

                TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtIoPosition, partialWrtIoPosition, 1.0e-5 );

                TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtIoVelocity, partialWrtIoVelocity, 1.0e-5 );

                TUDAT_CHECK_MATRIX_CLOSE_FRACTION(
                        testPartialWrtJupiterGravitationalParameter, partialWrtJupiterGravitationalParameter, 1.0e-6 );

                TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtIoGravitationalParameter, partialWrtIoGravitationalParameter, 1.0e-6 );

                TUDAT_CHECK_MATRIX_CLOSE_FRACTION( testPartialWrtTidalTimeLag, partialWrtTidalTimeLag, 1.0e-6 );
            }
        }
    }
}
...
BOOST_AUTO_TEST_CASE( testPanelledSurfaceRadiationPressureAccelerationPartials )
{
    ...
    earth->setShapeModel( createBodyShapeModel( getDefaultBodyShapeSettings( "Earth", TUDAT_NAN, TUDAT_NAN ), "Earth" ) );
    // Set current state of sun and earth.
    sun->setState( getBodyCartesianStateAtEpoch( "Sun", "SSB", "J2000", "NONE", 1.0E6 ) );
    earth->setState( getBodyCartesianStateAtEpoch( "Earth", "SSB", "J2000", "NONE", 1.0E6 ) );
    ...
    const auto tleEphemeris = std::make_shared< TleEphemeris >( "Earth", "J2000", tle );
    vehicle->setState( tleEphemeris->getCartesianState( tle->getEpoch( ) ) +
                       getBodyCartesianStateAtEpoch( "Earth", "SSB", "J2000", "NONE", 1.0E6 ) );

    std::shared_ptr< ephemerides::SimpleRotationalEphemeris > simpleRotationalEphemeris =
            std::make_shared< ephemerides::SimpleRotationalEphemeris >(
                    spice_interface::computeRotationQuaternionBetweenFrames( "J2000", "IAU_Earth", 0.0 ),
                    2.0 * mathematical_constants::PI / 86400.0,
                    0.0,
                    "J2000",
                    "IAU_Earth" );
    ...
    bodies.at( "Earth" )->setRadiationSourceModel(
            createRadiationSourceModel( getKnockeEarthRadiationPressureSettings( ), "Earth", bodies ) );
    ...
    parametersNames.push_back( std::make_shared< InitialTranslationalStateEstimatableParameterSettings< double > >(
            "Vehicle", getBodyCartesianStateAtEpoch( "Earth", "SSB", "J2000", "NONE", 1.0E6 ), "SSB", "J2000" ) );
    parametersNames.push_back( std::make_shared< InitialTranslationalStateEstimatableParameterSettings< double > >(
            "Earth", tleEphemeris->getCartesianState( tle->getEpoch( ) ), "Earth", "J2000" ) );
    std::shared_ptr< EstimatableParameterSet< double > > parametersToEstimate =
            createParametersToEstimate< double >( parametersNames, bodies, nullptr );

    // Create acceleration model.
    std::shared_ptr< RadiationPressureAcceleration > accelerationModel =
            createRadiationPressureAccelerationModel( bodies.at( "Vehicle" ), bodies.at( "Earth" ), "Vehicle", "Earth", bodies );
    accelerationModel->updateMembers( 1.0E7 );

    // Create partial-calculating object.
    std::shared_ptr< AccelerationPartial > accelerationPartial = createAnalyticalAccelerationPartial(
            accelerationModel, std::make_pair( "Vehicle", vehicle ), std::make_pair( "Earth", earth ), bodies, parametersToEstimate );
...
BOOST_AUTO_TEST_CASE( testThrustPartials )
{
    ...
    for( unsigned int i = 0; i < 2; i++ )
    {
        ...
        std::function< Eigen::Vector3d( const double ) > thrustDirectionFunction = [ = ]( const double ) {
        ...
        std::shared_ptr< ThrustAccelerationPartial > thrustPartial =
                std::dynamic_pointer_cast< ThrustAccelerationPartial >( createAnalyticalAccelerationPartial(
                        thrustAcceleration, std::make_pair( "Vehicle", vehicle ), std::make_pair( "Vehicle", vehicle ), bodies ) );
        ...
        Eigen::Vector3d partialWrtEngine1Thrust = thrustPartial->wrtParameter( constantThrustParameter1 );
        Eigen::Vector3d partialWrtEngine2Thrust = thrustPartial->wrtParameter( constantThrustParameter2 );
...
BOOST_AUTO_TEST_CASE( testYarkovskyPartials )
{
    ...
    // Create acceleration due to sun on earth.
    std::shared_ptr< YarkovskyAcceleration > yarkovskyAccelerationModel = std::dynamic_pointer_cast< YarkovskyAcceleration >(
            createAccelerationModel( earth, sun, yarkovskyAcceleration( yarkovskyParameter ), "Earth", "Sun" ) );

    // Create central gravity partial.
    std::shared_ptr< AccelerationPartial > yarkovskyPartial = createAnalyticalAccelerationPartial(
            yarkovskyAccelerationModel, std::make_pair( "Earth", earth ), std::make_pair( "Sun", sun ), bodies );

    // Create gravitational parameter object.
    std::shared_ptr< EstimatableParameter< double > > yarkovskyParameterParameter =
            std::make_shared< YarkovskyParameter >( yarkovskyAccelerationModel, "Earth", "Sun" );
    ...
    Eigen::Vector3d partialWrtSunYarkovskyParameter = yarkovskyPartial->wrtParameter( yarkovskyParameterParameter );
    ...
    Eigen::Vector3d testPartialWrtSunYarkovskyParameter =
            calculateAccelerationWrtParameterPartials( yarkovskyParameterParameter, yarkovskyAccelerationModel, 1.0E-6 );
