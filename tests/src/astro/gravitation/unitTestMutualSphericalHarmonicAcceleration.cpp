...
std::pair< Eigen::MatrixXd, Eigen::MatrixXd > generateCosineSineCoefficients( const int maximumDegree,
...
std::shared_ptr< tudat::simulation_setup::GravityFieldSettings > getDummyJovianSystemGravityField( const std::string& bodyName )
{
    ...
    else if( bodyName == "Io" )
    {
        ...
        gravityFieldSettings = std::make_shared< SphericalHarmonicsGravityFieldSettings >(
                5.959916033410404E012, 200.0 * getAverageRadius( "Io" ), coefficients.first, coefficients.second, "IAU_Io" );
    }
    else if( bodyName == "Europa" )
    {
        ...
        gravityFieldSettings = std::make_shared< SphericalHarmonicsGravityFieldSettings >(
                3.202738774922892E12, 200.0 * getAverageRadius( "Europa" ), coefficients.first, coefficients.second, "IAU_Europa" );
    }
...
BOOST_AUTO_TEST_CASE( testMutualSphericalHarmonicGravity )
{
    ...
    bodySettings.at( "Jupiter" )->ephemerisSettings =
            std::make_shared< KeplerEphemerisSettings >( ( Eigen::Vector6d( ) << 778.57E9, 0.0489, 1.3 / 60.0, 0.0, 0.0, 0.0 ).finished( ),
                                                         0.0,
                                                         getBodyGravitationalParameter( "Sun" ),
                                                         "Sun",
                                                         "ECLIPJ2000" );
    bodySettings.at( "Io" )->ephemerisSettings =
            std::make_shared< KeplerEphemerisSettings >( ( Eigen::Vector6d( ) << 421.8E6, 0.004, 0.04 / 60.0, 0.0, 0.0, 0.0 ).finished( ),
                                                         0.0,
                                                         getBodyGravitationalParameter( "Jupiter" ),
                                                         "Sun",
                                                         "ECLIPJ2000" );
    bodySettings.at( "Europa" )->ephemerisSettings =
            std::make_shared< KeplerEphemerisSettings >( ( Eigen::Vector6d( ) << 671.1E6, 0.009, 0.47 / 60.0, 0.0, 0.0, 0.0 ).finished( ),
                                                         0.0,
                                                         getBodyGravitationalParameter( "Jupiter" ),
                                                         "Sun",
                                                         "ECLIPJ2000" );
    ...
    std::shared_ptr< SphericalHarmonicsGravityField > jupiterGravityField =
            std::dynamic_pointer_cast< SphericalHarmonicsGravityField >( ( bodies.at( "Jupiter" ) )->getGravityFieldModel( ) );
    ...
    std::shared_ptr< SphericalHarmonicsGravityField > europaGravityField =
            std::dynamic_pointer_cast< SphericalHarmonicsGravityField >( ( bodies.at( "Europa" ) )->getGravityFieldModel( ) );
    ...
    std::shared_ptr< CentralGravitationalAccelerationModel3d > centralGravity =
            std::dynamic_pointer_cast< CentralGravitationalAccelerationModel3d >( createAccelerationModel( bodies.at( "Io" ),
                                                                                                           bodies.at( "Jupiter" ),
    ...
    std::shared_ptr< SphericalHarmonicsGravitationalAccelerationModel > sphericalHarmonicGravityOnIoFromJupiter =
            std::dynamic_pointer_cast< SphericalHarmonicsGravitationalAccelerationModel >(
                    createAccelerationModel( bodies.at( "Io" ),
                                             bodies.at( "Jupiter" ),
                                             sphericalHarmonicGravityOnIoFromJupiterSettings,
                                             "Io",
                                             "Jupiter",
                                             bodies.at( "Jupiter" ),
                                             "Jupiter" ) );
    ...
    std::shared_ptr< SphericalHarmonicsGravitationalAccelerationModel > sphericalHarmonicGravityOnJupiterFromIo =
            std::dynamic_pointer_cast< SphericalHarmonicsGravitationalAccelerationModel >(
                    createAccelerationModel( bodies.at( "Jupiter" ),
                                             bodies.at( "Io" ),
                                             sphericalHarmonicGravityOnJupiterFromIoSettings,
                                             "Jupiter",
                                             "Io",
                                             bodies.at( "Io" ),
                                             "Io" ) );
    ...
    std::shared_ptr< MutualSphericalHarmonicsGravitationalAccelerationModel > mutualDirectJupiterIoShGravity =
            std::dynamic_pointer_cast< MutualSphericalHarmonicsGravitationalAccelerationModel >(
                    createAccelerationModel( bodies.at( "Io" ),
                                             bodies.at( "Jupiter" ),
                                             mutualDirectJupiterIoShGravitySettings,
                                             "Io",
                                             "Jupiter",
                                             bodies.at( "Jupiter" ),
                                             "Jupiter" ) );
    ...
    std::shared_ptr< MutualSphericalHarmonicsGravitationalAccelerationModel > mutualDirectJupiterIoShGravity2 =
            std::dynamic_pointer_cast< MutualSphericalHarmonicsGravitationalAccelerationModel >(
                    createAccelerationModel( bodies.at( "Jupiter" ),
                                             bodies.at( "Io" ),
                                             mutualDirectJupiterIoShGravitySettings2,
                                             "Jupiter",
                                             "Io",
                                             bodies.at( "Io" ),
                                             "Io" ) );
    ...
    expectedAcceleration = centralGravityAcceleration - sphericalHarmonicGravityOnIoFromJupiterAcceleration +
            sphericalHarmonicGravityOnJupiterFromIoAcceleration;
    ...
    std::shared_ptr< ThirdBodyMutualSphericalHarmonicsGravitationalAccelerationModel > mutualThirdBodyIoOnEuropaShGravity =
            std::dynamic_pointer_cast< ThirdBodyMutualSphericalHarmonicsGravitationalAccelerationModel >(
                    createAccelerationModel( bodies.at( "Europa" ),
                                             bodies.at( "Io" ),
                                             mutualThirdBodyIoOnEuropaShGravitySettings,
                                             "Europa",
                                             "Io",
                                             bodies.at( "Jupiter" ),
                                             "Jupiter" ) );
    ...
    Eigen::Vector3d directAccelerationFromThirdBodyModel =
            mutualThirdBodyIoOnEuropaShGravity->getAccelerationModelForBodyUndergoingAcceleration( )->getAcceleration( );
    Eigen::Vector3d centralBodyAccelerationFromThirdBodyModel =
            mutualThirdBodyIoOnEuropaShGravity->getAccelerationModelForCentralBody( )->getAcceleration( );

    for( unsigned int i = 0; i < 3; i++ )
    {
        BOOST_CHECK_SMALL( ( directAccelerationFromThirdBodyModel( i ) -
        ...
        BOOST_CHECK_SMALL( centralBodyAccelerationFromThirdBodyModel( i ) -
                                   ( ioGravityField->getGravitationalParameter( ) /
        ...
        BOOST_CHECK_SMALL( mutualThirdBodyIoOnEuropaShGravityAcceleration( i ) -
