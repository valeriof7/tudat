...
BOOST_AUTO_TEST_CASE( testIfmsObservationMex )
{
    ...
    //    ifmsFileNames.push_back( paths::getTudatTestDataPath( )  +
    //    "/estrack_n_way_doppler_observation_model/M32ICL3L02_D2S_133621819_00.TAB.txt" ); ifmsFileNames.push_back(
    //    paths::getTudatTestDataPath( )  + "/estrack_n_way_doppler_observation_model/M32ICL2L02_D2X_133621904_00.TAB.txt" );
    //    ifmsFileNames.push_back( paths::getTudatTestDataPath( )  +
    //    "/estrack_n_way_doppler_observation_model/M32ICL2L02_D2X_133621819_00.TAB.txt" ); ifmsFileNames.push_back(
    //    paths::getTudatTestDataPath( )  + "/estrack_n_way_doppler_observation_model/M32ICL1L02_D2X_133621904_00.TAB.txt" );
    //    ifmsFileNames.push_back( paths::getTudatTestDataPath( )  +
    //    "/estrack_n_way_doppler_observation_model/M32ICL1L02_D2X_133621819_00.TAB.txt" );
    ...
    for( int i = 0; i < 1; i++ )  // rawIfmsFiles.size( ); i++ )
    {
        ...
        for( int testType = 0; testType < 2; testType++ )
        {
            ...
            std::shared_ptr< GroundStationSettings > nnorciaSettings =
                    std::make_shared< GroundStationSettings >( "NWNORCIA", stationPosition );
