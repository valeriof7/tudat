...
BOOST_AUTO_TEST_CASE( test_PI )
{
    ...
    BOOST_CHECK_CLOSE( mathematical_constants::PI, circumference / ( 2.0 * radius ), std::numeric_limits< double >::epsilon( ) );
}
...
BOOST_AUTO_TEST_CASE( test_TemplatedValues )
{
    ...
    BOOST_CHECK_CLOSE( mathematical_constants::getFloatingInteger< double >( 1 ), one, std::numeric_limits< double >::epsilon( ) );
    BOOST_CHECK_CLOSE(
            mathematical_constants::getFloatingInteger< long double >( 1 ), longOne, std::numeric_limits< long double >::epsilon( ) );

    BOOST_CHECK_SMALL( mathematical_constants::getFloatingInteger< double >( 0 ), std::numeric_limits< double >::epsilon( ) );
    BOOST_CHECK_SMALL( mathematical_constants::getFloatingInteger< long double >( 0 ), std::numeric_limits< long double >::epsilon( ) );

    double two = 2.0;
    long double longTwo = 2.00000000000000000000L;

    BOOST_CHECK_CLOSE( mathematical_constants::getFloatingInteger< double >( 2 ), two, std::numeric_limits< double >::epsilon( ) );
    BOOST_CHECK_CLOSE(
            mathematical_constants::getFloatingInteger< long double >( 2 ), longTwo, std::numeric_limits< long double >::epsilon( ) );

    BOOST_CHECK_CLOSE(
            mathematical_constants::getFloatingFraction< double >( 1, 2 ),
            mathematical_constants::getFloatingInteger< double >( 1 ) / mathematical_constants::getFloatingInteger< double >( 2 ),
            std::numeric_limits< double >::epsilon( ) );
    BOOST_CHECK_CLOSE(
            mathematical_constants::getFloatingFraction< long double >( 1, 2 ),
            mathematical_constants::getFloatingInteger< long double >( 1 ) / mathematical_constants::getFloatingInteger< long double >( 2 ),
            std::numeric_limits< long double >::epsilon( ) );

    BOOST_CHECK_CLOSE( mathematical_constants::getPi< double >( ), mathematical_constants::PI, std::numeric_limits< double >::epsilon( ) );
    BOOST_CHECK_CLOSE( mathematical_constants::getPi< long double >( ),
                       mathematical_constants::LONG_PI,
                       std::numeric_limits< long double >::epsilon( ) );
}
