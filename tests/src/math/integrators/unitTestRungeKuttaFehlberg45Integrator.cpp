...
//             std::cout<<i<<" "<<table5_9BurdenAndFaires( i, EXPECTED_RELATIVE_ERROR_COLUMN_INDEX )<<"
//             "<<burdenAndFairesNumericalIntegratorTest.relativeError_( 0 )<<std::endl;
//
...
BOOST_AUTO_TEST_CASE( testRungeKuttaFehlberg45IntegratorUsingMatlabData )
{
    ...
    const std::string pathToForwardIntegrationOutputFile = paths::getTudatTestDataPath( ) + "/matlabOutputRungeKuttaFehlberg45Forward.txt";
    const std::string pathToDiscreteEventIntegrationOutputFile =
            paths::getTudatTestDataPath( ) + "/matlabOutputRungeKuttaFehlberg45DiscreteEvent.txt";
