 ...
 * \f]
 */
struct TestFunction2 : public TestFunction, public basic_mathematics::BasicFunction< double, double > {
    ...
    TestFunction2( const unsigned int aMaximumDerivativeOrder ): maximumDerivativeOrder( aMaximumDerivativeOrder ) { }
