                                                          ...
                                                          const Eigen::Vector3d& initialPositionOfPoint )
{
    ...
    const Eigen::Vector3d initialPositionOfPointWithRespectToOriginOfRotation = initialPositionOfPoint - originOfRotation;
                                                           ...
                                                           const Eigen::Vector3d& initialVector )
{
    ...
    Eigen::Vector3d rotatedPositionOfVectorTail =
            computeRotationOfPointAboutArbitraryAxis( originOfRotation, angleOfRotation, axisOfRotation, initialPositionOfVectorTail );
