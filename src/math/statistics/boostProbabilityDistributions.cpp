    ...
    switch( boostDistribution )
    {
        case uniform_boost_distribution: {
            ...
            else
            {
                ...
                continuousRandomVariable =
                        std::make_shared< BoostContinuousProbabilityDistribution< uniform_distribution<> > >( uniformDistribution );
            }
            break;
        }
        case normal_boost_distribution: {
            ...
            else
            {
                ...
                continuousRandomVariable =
                        std::make_shared< BoostContinuousProbabilityDistribution< normal_distribution<> > >( normalDistribution );
            }
            break;
        }
        case exponential_boost_distribution: {
            ...
            else
            {
                ...
                continuousRandomVariable =
                        std::make_shared< BoostContinuousProbabilityDistribution< exponential_distribution<> > >( exponentialDistribution );
            }
            break;
        }
        case gamma_boost_distribution: {
            ...
            else
            {
                ...
                continuousRandomVariable =
                        std::make_shared< BoostContinuousProbabilityDistribution< gamma_distribution<> > >( gammaDistribution );
            }
            break;
        }
        case lognormal_boost_distribution: {
            ...
            else
            {
                ...
                continuousRandomVariable =
                        std::make_shared< BoostContinuousProbabilityDistribution< lognormal_distribution<> > >( logNormalDistribution );
            }
            break;
        }
        case beta_boost_distribution: {
            ...
            else
            {
                ...
                continuousRandomVariable =
                        std::make_shared< BoostContinuousProbabilityDistribution< beta_distribution<> > >( betaDistribution );
            }
            break;
        }
        default:
