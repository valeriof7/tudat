    ...
    switch( parameterType )
    {
        case initial_body_state: {
            std::shared_ptr< InitialTranslationalStateEstimatableParameterSettings< double > > stateEstimationSettings =
                    std::dynamic_pointer_cast< InitialTranslationalStateEstimatableParameterSettings< double > >( parameterSettings );
        ...
        case arc_wise_initial_body_state: {
            std::shared_ptr< ArcWiseInitialTranslationalStateEstimatableParameterSettings< double > > stateEstimationSettings =
                    std::dynamic_pointer_cast< ArcWiseInitialTranslationalStateEstimatableParameterSettings< double > >(
                            parameterSettings );
            assertNonnullptrPointer( stateEstimationSettings );
            jsonObject[ K::initialStateValue ] = stateEstimationSettings->initialStateValue_;
        ...
        case constant_additive_observation_bias: {
            std::shared_ptr< ConstantObservationBiasEstimatableParameterSettings > biasSettings =
                    std::dynamic_pointer_cast< ConstantObservationBiasEstimatableParameterSettings >( parameterSettings );
        ...
        case arcwise_constant_additive_observation_bias: {
            std::shared_ptr< ArcWiseConstantObservationBiasEstimatableParameterSettings > biasSettings =
                    std::dynamic_pointer_cast< ArcWiseConstantObservationBiasEstimatableParameterSettings >( parameterSettings );
            assertNonnullptrPointer( biasSettings );
            jsonObject[ K::observableType ] = biasSettings->observableType_;
            jsonObject[ K::linkEnds ] = biasSettings->linkEnds_;
        ...
        case spherical_harmonics_cosine_coefficient_block: {
            std::shared_ptr< SphericalHarmonicEstimatableParameterSettings > coefficientSettings =
                    std::dynamic_pointer_cast< SphericalHarmonicEstimatableParameterSettings >( parameterSettings );
        ...
        case arc_wise_radiation_pressure_coefficient: {
            std::shared_ptr< ArcWiseRadiationPressureCoefficientEstimatableParameterSettings > coefficientSettings =
                    std::dynamic_pointer_cast< ArcWiseRadiationPressureCoefficientEstimatableParameterSettings >( parameterSettings );
            assertNonnullptrPointer( coefficientSettings );
        ...
        case full_degree_tidal_love_number: {
            std::shared_ptr< FullDegreeTidalLoveNumberEstimatableParameterSettings > loveNumberSettings =
                    std::dynamic_pointer_cast< FullDegreeTidalLoveNumberEstimatableParameterSettings >( parameterSettings );
        ...
        case single_degree_variable_tidal_love_number: {
            std::shared_ptr< SingleDegreeVariableTidalLoveNumberEstimatableParameterSettings > loveNumberSettings =
                    std::dynamic_pointer_cast< SingleDegreeVariableTidalLoveNumberEstimatableParameterSettings >( parameterSettings );
            assertNonnullptrPointer( loveNumberSettings );
            jsonObject[ K::deformingBodies ] = loveNumberSettings->deformingBodies_;
            jsonObject[ K::degree ] = loveNumberSettings->degree_;
...
void from_json( const nlohmann::json& jsonObject, std::shared_ptr< EstimatableParameterSettings >& parameterSettings )
{
    ...
    const EstimatebleParametersEnum parameterType = getValue< EstimatebleParametersEnum >( jsonObject, K::parameterType );
    const std::string bodyName = getValue< std::string >( jsonObject, K::associatedBody );

    switch( parameterType )
    {
        case initial_body_state: {
            parameterSettings = std::make_shared< InitialTranslationalStateEstimatableParameterSettings< double > >(
                    bodyName,
        ...
        case arc_wise_initial_body_state: {
            try
            {
                parameterSettings = std::make_shared< ArcWiseInitialTranslationalStateEstimatableParameterSettings< double > >(
                        bodyName,
        ...
        case direct_dissipation_tidal_time_lag: {
            parameterSettings = std::make_shared< DirectTidalTimeLagEstimatableParameterSettings >(
                    bodyName, getValue< std::vector< std::string > >( jsonObject, K::deformingBodies ) );
            return;
        }
        case constant_additive_observation_bias:
            //    {
        ...
        case spherical_harmonics_cosine_coefficient_block: {
            ...
            {
                parameterSettings =
                        std::make_shared< SphericalHarmonicEstimatableParameterSettings >( getValue< int >( jsonObject, K::minimumDegree ),
            ...
            catch( ... )
            {
                try
                {
                    parameterSettings = std::make_shared< SphericalHarmonicEstimatableParameterSettings >(
                            getValue< std::vector< std::pair< int, int > > >( jsonObject, K::coefficientIndices ),
                            bodyName,
                            spherical_harmonics_cosine_coefficient_block );
                    if( parameterSet == true )
                    {
                        std::cerr << "Warning when reading spherical harmonic coefficient estimation settings from JSON, duplicate "
        ...
        case empirical_acceleration_coefficients: {
            parameterSettings = std::make_shared< EmpiricalAccelerationEstimatableParameterSettings >(
                    bodyName,
                    getValue< std::string >( jsonObject, K::centralBody ),
        ...
        case arc_wise_radiation_pressure_coefficient: {
            parameterSettings = std::make_shared< ArcWiseRadiationPressureCoefficientEstimatableParameterSettings >(
                    bodyName, getValue< std::vector< double > >( jsonObject, K::arcStartTimes ) );
            return;
        }
        case arc_wise_empirical_acceleration_coefficients: {
            parameterSettings = std::make_shared< ArcWiseEmpiricalAccelerationEstimatableParameterSettings >(
                    bodyName,
                    getValue< std::string >( jsonObject, K::centralBody ),
                    getValue< std::map< basic_astrodynamics::EmpiricalAccelerationComponents,
                                        std::vector< basic_astrodynamics::EmpiricalAccelerationFunctionalShapes > > >(
        ...
        case full_degree_tidal_love_number: {
            parameterSettings = std::make_shared< FullDegreeTidalLoveNumberEstimatableParameterSettings >(
                    bodyName,
                    getValue< int >( jsonObject, K::degree ),
                    getValue< std::vector< std::string > >( jsonObject, K::deformingBodies ),
                    getValue< bool >( jsonObject, K::useComplexValue ) );
            return;
        }
        case single_degree_variable_tidal_love_number: {
            parameterSettings = std::make_shared< SingleDegreeVariableTidalLoveNumberEstimatableParameterSettings >(
                    bodyName,
                    getValue< int >( jsonObject, K::degree ),
        ...
        default: {
            parameterSettings = std::make_shared< EstimatableParameterSettings >(
                    bodyName, parameterType, getValue< std::string >( jsonObject, K::secondaryIdentifier, "" ) );
            return;
        }
    }
}
