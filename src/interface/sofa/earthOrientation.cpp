...
Eigen::Vector3d getPositionOfCipInGcrs( const double terrestrialTime,
                                        const double julianDaysEpochShift,
                                        const basic_astrodynamics::IAUConventions precessionNutationTheory )
{
    ...
    switch( precessionNutationTheory )
    {
        case basic_astrodynamics::iau_2000_a:
            iauXys00a( julianDaysEpochShift, terrestrialTime / physical_constants::JULIAN_DAY, &xAngle, &yAngle, &originLocator );
            break;

        case basic_astrodynamics::iau_2000_b:
            iauXys00b( julianDaysEpochShift, terrestrialTime / physical_constants::JULIAN_DAY, &xAngle, &yAngle, &originLocator );
            break;

        case basic_astrodynamics::iau_2006:
            iauXys06a( julianDaysEpochShift, terrestrialTime / physical_constants::JULIAN_DAY, &xAngle, &yAngle, &originLocator );
            break;
        default:
                                           ...
                                           const basic_astrodynamics::IAUConventions iauConvention )
{
    ...
    {
        case basic_astrodynamics::iau_2000_a:
            gmst = iauGmst00( referenceJulianDay,
        ...
        case basic_astrodynamics::iau_2006:
            gmst = iauGmst06( referenceJulianDay,
                              universalTime1 / physical_constants::JULIAN_DAY,
                              referenceJulianDay,
                              terrestrialTime / physical_constants::JULIAN_DAY );
            break;
...
template<>
double calculateEarthRotationAngleTemplated< double >( const double currentUt1 )
{
...
template<>
double calculateEarthRotationAngleTemplated< Time >( const Time currentUt1 )
{
