        ...
        const std::shared_ptr< BaseFunctionHodographicShapingSettings > baseFunctionSettings )
{
    ...
    switch( baseFunctionType )
    {
        ...
        case sine: {
            ...
            if( trigonometricFunctionSettings != nullptr )
            {
                baseFunctionHodographicShaping =
                        std::make_shared< SineFunctionHodographicShaping >( trigonometricFunctionSettings->frequency_ );
            }
            else
            {
                throw std::runtime_error(
                        "Error when creating sine base function for hodographic shaping, "
        ...
        case cosine: {
            ...
            {
                baseFunctionHodographicShaping =
                        std::make_shared< CosineFunctionHodographicShaping >( trigonometricFunctionSettings->frequency_ );
            }
            else
            {
                throw std::runtime_error(
                        "Error when creating cosine base function for hodographic shapign, "
                        "unconsistent settings were provided." );
            }
            break;
        }
        case exponential: {
            ...
            {
                baseFunctionHodographicShaping =
                        std::make_shared< ExponentialFunctionHodographicShaping >( exponentialFunctionSettings->exponent_ );
            }
            else
            {
                throw std::runtime_error(
                        "Error when creating exponential base function for hodographic shaping,"
                        " unconsistent settings were provided." );
            }
            break;
        }
        case scaledExponential: {
            ...
            if( exponentialFunctionSettings != nullptr )
            {
                baseFunctionHodographicShaping = std::make_shared< ScaledExponentialFunctionHodographicShaping >(
                        exponentialFunctionSettings->exponent_, exponentialFunctionSettings->scaleFactor_ );
            }
            else
            {
                throw std::runtime_error(
                        "Error when creating scaled exponential base function for hodographic shaping, "
                        "unconsistent settings were provided." );
            }
            break;
        }
        case exponentialSine: {
            ...
            if( exponentialTimeSineFunctionSettings != nullptr )
            {
                baseFunctionHodographicShaping = std::make_shared< ExponentialSineFunctionHodographicShaping >(
                        exponentialTimeSineFunctionSettings->exponent_, exponentialTimeSineFunctionSettings->frequency_ );
            }
            else
            {
                throw std::runtime_error(
                        "Error when creating exponential time sine base function for hodographic shaping, "
                        "unconsistent settings were provided." );
            }
            break;
        }
        case scaledExponentialSine: {
            ...
            {
                throw std::runtime_error(
                        "Error when creating scaled exponential time sine base function for hodographic shaping, "
                        "unconsistent settings were provided." );
            }
            break;
        }
        case exponentialCosine: {
            ...
            if( exponentialTimesCosineFunctionSettings != nullptr )
            {
                baseFunctionHodographicShaping = std::make_shared< ExponentialCosineFunctionHodographicShaping >(
                        exponentialTimesCosineFunctionSettings->exponent_, exponentialTimesCosineFunctionSettings->frequency_ );
            }
            else
            {
                throw std::runtime_error(
                        "Error when creating exponential time cosine base function for hodographic shaping, "
                        "unconsistent settings were provided." );
            }
            break;
        }
        case scaledExponentialCosine: {
            ...
            {
                throw std::runtime_error(
                        "Error when creating scaled exponential time cosine base function for hodographic shaping, "
                        "unconsistent settings were provided." );
            }
            break;
        }
        case power: {
            ...
            {
                throw std::runtime_error(
                        "Error when creating power base function for hodographic shaping, "
                        "unconsistent settings were provided." );
            }
            break;
        }
        case scaledPower: {
            ...
            {
                throw std::runtime_error(
                        "Error when creating scaled power base function for hodographic shaping, "
                        "unconsistent settings were provided." );
            }
            break;
        }
        case powerSine: {
            ...
            {
                baseFunctionHodographicShaping = std::make_shared< PowerSineFunctionHodographicShaping >(
                        powerTimesSineFunctionSettings->exponent_, powerTimesSineFunctionSettings->frequency_ );
            }
            else
            {
                throw std::runtime_error(
                        "Error when creating power times sine base function for hodographic shaping, "
                        "unconsistent settings were provided." );
            }
            break;
        }
        case scaledPowerSine: {
            ...
            {
                throw std::runtime_error(
                        "Error when creating scaled power times sine base function for hodographic shaping, "
                        "unconsistent settings were provided." );
            }
            break;
        }
        case powerCosine: {
            ...
            if( powerTimesCosineFunctionSettings != nullptr )
            {
                baseFunctionHodographicShaping = std::make_shared< PowerCosineFunctionHodographicShaping >(
                        powerTimesCosineFunctionSettings->exponent_, powerTimesCosineFunctionSettings->frequency_ );
            }
            else
            {
                throw std::runtime_error(
                        "Error when creating power times cosine base function for hodographic shaping, "
                        "unconsistent settings were provided." );
            }
            break;
        }
        case scaledPowerCosine: {
            ...
            {
                throw std::runtime_error(
                        "Error when creating scaled power times cosine base function for hodographic shaping, "
                        "unconsistent settings were provided." );
            }
            break;
        }
        default: {
            throw std::runtime_error( "Error, did not recognize base function type for hodographic shaping." );
        }
    }
