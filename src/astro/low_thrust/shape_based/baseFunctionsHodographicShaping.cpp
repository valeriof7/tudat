...
{
    return std::exp( exponentExponentialFunction_ * independentVariable ) * std::sin( frequencySineFunction_ * independentVariable );
}
...
{
    return std::exp( exponentExponentialFunction_ * independentVariable ) * std::cos( frequencyCosineFunction_ * independentVariable );
}
...
{
    return std::pow( independentVariable, exponentPowerFunction_ ) * std::sin( frequencySineFunction_ * independentVariable );
}
...
double PowerSineFunctionHodographicShaping::evaluateDerivative( const double independentVariable )
{
    return exponentPowerFunction_ * std::pow( independentVariable, exponentPowerFunction_ - 1.0 ) *
            std::sin( frequencySineFunction_ * independentVariable ) +
            std::pow( independentVariable, exponentPowerFunction_ ) * frequencySineFunction_ *
...
double PowerSineFunctionHodographicShaping::evaluateIntegral( const double independentVariable )
{
    ...
    for( int counterSuccessiveIntegrations = 1; counterSuccessiveIntegrations <= exponentPowerFunction_ + 1;
         counterSuccessiveIntegrations++ )
    {
...
{
    return std::pow( independentVariable, exponentPowerFunction_ ) * std::cos( frequencyCosineFunction_ * independentVariable );
}
...
double PowerCosineFunctionHodographicShaping::evaluateDerivative( const double independentVariable )
{
    return exponentPowerFunction_ * std::pow( independentVariable, exponentPowerFunction_ - 1.0 ) *
            std::cos( frequencyCosineFunction_ * independentVariable ) -
            std::pow( independentVariable, exponentPowerFunction_ ) * frequencyCosineFunction_ *
