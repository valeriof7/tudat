                                                                          ...
                                                                          const Eigen::Vector3d& pAuxiliaryVector )
{
    ...
    stateDerivative.segment( 3, 4 ) =
            calculateExponentialMapDerivative( currentUnifiedStateModelElements.segment( 3, 4 ), rotationalVelocityVector );
                                                                          ...
                                                                          const double centralBodyGravitationalParameter )
{
    ...
    Eigen::Vector4d quaternionElements =
            convertExponentialMapToQuaternionElements( currentUnifiedStateModelElements.segment( e1USMEMIndex, 4 ) );
    ...
    double gammaParameter =
            ( epsilonQuaternionVector( 0 ) * epsilonQuaternionVector( 2 ) - epsilonQuaternionVector( 1 ) * etaQuaternionParameter ) /
            denominator;
    ...
    rotationalVelocityVector( 2 ) = std::pow( velocityHodographParameter, 2 ) * currentUnifiedStateModelElements( CHodographUSMEMIndex ) /
    ...
    // Evaluate USMEM equations
    return computeStateDerivativeForUnifiedStateModelExponentialMap( currentUnifiedStateModelElements,
