...
Eigen::Vector6d TleEphemeris::getCartesianState( double secondsSinceEpoch )
{
    ...
    const Eigen::Vector6d cartesianStateAtEpochTEME = spice_interface::getCartesianStateFromTleAtEpoch( utcSecondSinceEpoch, tle_ );
    ...
    sofa_interface::getPrecessionAngles(
            precessionAngleModToGcrfZeta, precessionAngleModToGcrfZ, precessionAngleModToGcrfTheta, secondsSinceEpoch );
    ...
    else if( referenceFrameOrientation_ == "ECLIPJ2000" )
    {
        Eigen::Quaterniond itrsToEclipticQuaternion =
                spice_interface::computeRotationQuaternionBetweenFrames( "J2000", "ECLIPJ2000", secondsSinceEpoch );
