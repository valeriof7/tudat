                                                              ...
                                                              const double ppnParameterGamma )
{
    ...
    return ( 1.0 + ppnParameterGamma ) * bodyGravitationalParameter * physical_constants::INVERSE_CUBIC_SPEED_OF_LIGHT *
            std::log( ( distanceToReceiver + distanceToTransmitter + linkEuclideanDistance ) /
                                                                                         ...
                                                                                         const double ppnParameterGamma )
{
    ...
    return 2.0 * ppnParameterGamma * bodyGravitationalParameter * physical_constants::INVERSE_CUBIC_SPEED_OF_LIGHT * gradient /
            ( ( receiverDistance + transmitterDistance ) * ( receiverDistance + transmitterDistance ) - linkEndDistance * linkEndDistance );
}
