                                                               ...
                                                               const double relativeDistance )
{
    return centralBodyGravitationalParameter /
            ( physical_constants::SPEED_OF_LIGHT * physical_constants::SPEED_OF_LIGHT * relativeDistance * relativeDistance *
              relativeDistance );
}
...
{
    Eigen::Vector3d acceleration = ( 2.0 * ( ppnParameterGamma + ppnParameterBeta ) * centralBodyGravitationalParameter / relativeDistance -
                                     ppnParameterGamma * relativeVelocity.dot( relativeVelocity ) ) *
                    relativePosition +
...
//! Function to compute the Schwarzschild term of the relativistic acceleration correction.
Eigen::Vector3d calculateScharzschildGravitationalAccelerationCorrection( double centralBodyGravitationalParameter,
                                                                          ...
                                                                          double ppnParameterBeta )
{
    return calculateScharzschildGravitationalAccelerationCorrection(
            ...
            calculateRelativisticAccelerationCorrectionsCommonterm( centralBodyGravitationalParameter,
                                                                    relativeState.segment( 0, 3 ).norm( ) ),
            ppnParameterGamma,
            ppnParameterBeta );
}
...
Eigen::Vector3d calculateLenseThirringCorrectionAcceleration( const Eigen::Vector3d& relativePosition,
                                                              ...
                                                              const double ppnParameterGamma )
{
    Eigen::Vector3d acceleration = 3.0 / ( relativeDistance * relativeDistance ) * relativePosition.cross( relativeVelocity ) *
...
Eigen::Vector3d calculateLenseThirringCorrectionAcceleration( const double centralBodyGravitationalParameter,
                                                              ...
                                                              const double ppnParameterGamma )
{
    return calculateLenseThirringCorrectionAcceleration( relativeState.segment( 0, 3 ),
                                                         relativeState.segment( 3, 3 ),
                                                         relativeState.segment( 0, 3 ).norm( ),
                                                         ...
                                                         const double ppnParameterGamma )
{
    return calculateDeSitterCorrectionAcceleration(
            ...
            calculateRelativisticAccelerationCorrectionsCommonterm( largerBodyGravitationalParameter,
