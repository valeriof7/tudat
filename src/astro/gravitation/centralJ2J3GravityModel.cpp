...
Eigen::Vector3d computeGravitationalAccelerationDueToJ3( const Eigen::Vector3d& positionOfBodySubjectToAcceleration,
                                                         ...
                                                         const Eigen::Vector3d& positionOfBodyExertingAcceleration )
{
    ...
    const double preMultiplier = -gravitationalParameterOfBodyExertingAcceleration / std::pow( distanceBetweenBodies, 5.0 ) * 2.5 *
            j3CoefficientOfGravityField * std::pow( equatorialRadiusOfBodyExertingAcceleration, 3.0 );
    ...
    const double factorForXAndYDirections = ( 3.0 - 7.0 * scaledZCoordinateSquared ) * scaledZCoordinate / distanceBetweenBodies;
    ...
    gravitationalAccelerationDueToJ3( orbital_element_conversions::zCartesianPositionIndex ) *=
            ( -0.6 + 6.0 * scaledZCoordinateSquared - 7.0 * scaledZCoordinateSquared * scaledZCoordinateSquared );
