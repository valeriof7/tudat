                                                         ...
                                                         const Eigen::Vector3d& positionOfBodyExertingAcceleration )
{
    ...
    const double preMultiplier = -gravitationalParameterOfBodyExertingAcceleration / std::pow( distanceBetweenBodies, 4.0 ) * 1.5 *
            j2CoefficientOfGravityField * equatorialRadiusOfBodyExertingAcceleration * equatorialRadiusOfBodyExertingAcceleration;
    ...
    const double factorForXAndYDirections = ( 1.0 - 5.0 * scaledZCoordinateSquared ) / distanceBetweenBodies;
