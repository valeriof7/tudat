...
Eigen::VectorXd convertDimensionlessCartesianStateToDimensionalUnits( const Eigen::Vector6d& dimensionlessCartesianState,
                                                                      ...
                                                                      const double distanceBetweenPrimaries )
{
    ...
    dimensionalCartesianState.segment( 0, 3 ) = dimensionlessCartesianState.segment( 0, 3 ) * distanceBetweenPrimaries;

    // Convert velocity to dimensional units.
    dimensionalCartesianState.segment( 3, 3 ) = dimensionlessCartesianState.segment( 3, 3 ) *
            std::sqrt( ( gravitationalParameterOfPrimaryBody + gravitationalParameterOfSecondaryBody ) / distanceBetweenPrimaries );
...
double convertDimensionlessTimeToDimensionalTime( const double timeInDimensionlessUnits,
                                                  const double gravitationalParameterOfPrimaryBody,
                                                  const double gravitationalParameterOfSecondaryBody,
                                                  const double distanceBetweenPrimaries )
{
    return timeInDimensionlessUnits *
            std::sqrt( std::pow( distanceBetweenPrimaries, 3.0 ) /
...
Eigen::VectorXd convertDimensionalCartesianStateToDimensionlessState( const Eigen::Vector6d& dimensionalCartesianState,
                                                                      const double gravitationalParameterOfPrimaryBody,
                                                                      const double gravitationalParameterOfSecondaryBody,
                                                                      const double distanceBetweenPrimaries )
{
    ...
    // Convert position to dimensional units.
    dimensionlessCartesianState.segment( 0, 3 ) = dimensionalCartesianState.segment( 0, 3 ) / distanceBetweenPrimaries;

    // Convert velocity to dimensional units.
    dimensionlessCartesianState.segment( 3, 3 ) = dimensionalCartesianState.segment( 3, 3 ) *
            std::sqrt( distanceBetweenPrimaries / ( gravitationalParameterOfPrimaryBody + gravitationalParameterOfSecondaryBody ) );
...
double convertDimensionalTimeToDimensionlessTime( const double dimensionalTime,
                                                  const double gravitationalParameterOfPrimaryBody,
                                                  const double gravitationalParameterOfSecondaryBody,
                                                  const double distanceBetweenPrimaries )
{
    return dimensionalTime *
            std::sqrt( ( gravitationalParameterOfPrimaryBody + gravitationalParameterOfSecondaryBody ) /
                       std::pow( distanceBetweenPrimaries, 3.0 ) );
}

//! Convert corotating normalized state to inertial cartesian state.
Eigen::Vector6d convertCorotatingNormalizedToCartesianCoordinates( const double gravitationalParameterPrimary,
...
Eigen::Vector6d convertCartesianToCorotatingNormalizedCoordinates( const double gravitationalParameterPrimary,
                                                                   const double gravitationalParameterSecondary,
                                                                   const double distancePrimarySecondary,
                                                                   ...
                                                                   const double time )
{
    ...
    double meanMotion =
            std::sqrt( ( gravitationalParameterPrimary + gravitationalParameterSecondary ) / std::pow( distancePrimarySecondary, 3 ) );
