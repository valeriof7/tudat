                                                           ...
                                                           const double secondaryGravitationalParameter )
{
    ...
    double gravitationalParameterPrimary = ( primaryGravitationalParameter == primaryGravitationalParameter )
            ...
            : simulation_setup::createGravityFieldModel(
                      simulation_setup::getDefaultGravityFieldSettings( namePrimaryBody, TUDAT_NAN, TUDAT_NAN ), namePrimaryBody )
    ...
    double gravitationalParameterSecondary = ( secondaryGravitationalParameter == secondaryGravitationalParameter )
            ...
            : simulation_setup::createGravityFieldModel(
                      simulation_setup::getDefaultGravityFieldSettings( namePrimaryBody, TUDAT_NAN, TUDAT_NAN ), nameSecondaryBody )
                      ->getGravitationalParameter( );
    double massParameter =
            circular_restricted_three_body_problem::computeMassParameter( gravitationalParameterPrimary, gravitationalParameterSecondary );
    ...
    double gravitationalParameterPrimaryTwoBodyProblem = std::pow( distanceBarycenterPrimary, 3 ) * sumGravitationalParameter /
            std::pow( distanceBarycenterPrimary + distanceBarycenterSecondary, 3 );
    double gravitationalParameterSecondaryTwoBodyProblem = std::pow( distanceBarycenterSecondary, 3 ) * sumGravitationalParameter /
            std::pow( distanceBarycenterPrimary + distanceBarycenterSecondary, 3 );
                                                    ...
                                                    const double secondaryGravitationalParameter )
{
    ...
    simulation_setup::SystemOfBodies bodies = createSystemOfBodies( setupBodySettingsCR3BP( distancePrimarySecondary,
                                                                                            namePrimaryBody,
                                                                                            nameSecondaryBody,
                                                                                            frameOrientation,
                                                                                            primaryGravitationalParameter,
                                                                ...
                                                                const simulation_setup::SystemOfBodies& bodies )
{
    ...
    bodyToPropagateAccelerations[ namePrimaryBody ].push_back(
            std::make_shared< simulation_setup::AccelerationSettings >( basic_astrodynamics::point_mass_gravity ) );
    bodyToPropagateAccelerations[ nameSecondaryBody ].push_back(
            std::make_shared< simulation_setup::AccelerationSettings >( basic_astrodynamics::point_mass_gravity ) );
    simulation_setup::SelectedAccelerationMap accelerationMap;
    accelerationMap[ nameBodyToPropagate ] = bodyToPropagateAccelerations;

    basic_astrodynamics::AccelerationMap accelerationModelMap =
            createAccelerationModelsMap( bodies, accelerationMap, { nameBodyToPropagate }, { centralBody } );
                                    ...
                                    const bool outputInNormalizedCoordinates )
{
    ...
    Eigen::Vector6d normalizedInitialState = circular_restricted_three_body_problem::convertCartesianToCorotatingNormalizedCoordinates(
            gravitationalParameterSecondary, gravitationalParameterPrimary, distanceBetweenPrimaries, initialState, initialTime );
    ...
    CR3BPintegratorSettings->initialTimeStep_ =
            circular_restricted_three_body_problem::convertDimensionalTimeToDimensionlessTime( integratorSettings->initialTimeStep_,
                                                                                               gravitationalParameterPrimary,
                                                                                               gravitationalParameterSecondary,
        ...
        std::map< double, Eigen::VectorXd >& dependentVariableValues )
{
    ...
    propagateCR3BPFromEnvironment( initialTime,
                                   finalPropagationTime,
                                   propagatorSettings->getInitialStates( ),
                                   integratorSettings,
                                   bodies,
                                   bodiesCR3BP,
                                   cr3bpPropagationResult,
                                   false );
}
                                           ...
                                           std::map< double, Eigen::Vector6d >& cr3bpPropagationResult )
{
    ...
    std::map< double, Eigen::VectorXd > dependentVariableValues;
    propagateCR3BPAndFullDynamicsProblem( initialTime,
                                          integratorSettings,
                                          propagatorSettings,
                                          bodies,
                                          bodiesCR3BP,
